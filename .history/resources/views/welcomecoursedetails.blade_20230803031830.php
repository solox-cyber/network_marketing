                    ...
                    <div class="col-xl-4 col-xxl-3 col-lg-4">
                        ...
                        <div class="card w-100 border-0 mt-0 mb-4 p-4 shadow-xss position-relative rounded-lg bg-white">
                            <div class="row">
                                ...
                                <div class="col-7 pl-0 text-right">
                                    <div class="star d-block w-100 text-right">
                                        <img src="{{ asset('media/images/star.png')}}" alt="star" class="w10">
                                        <img src="{{ asset('media/images/star.png')}}" alt="star" class="w10">
                                        <img src="{{ asset('media/images/star.png')}}" alt="star" class="w10">
                                        <img src="{{ asset('media/images/star.png')}}" alt="star" class="w10">
                                        <img src="{{ asset('media/images/star-disable.png')}}" alt="star" class="w10">
                                    </div>
                            ...
                            <div class="bg-greylight theme-dark-bg rounded-sm p-2 mt-3 mb-4">
                                ...
                                <div class="row mt-1">
                                    <div class="col-3 pr-1 mt-0"><img src="{{ asset('media/images/star.png')}}" alt="star" class="w10 float-left"><h4 class="font-xsss fw-600 text-grey-600 ml-1 float-left d-inline">4</h4></div>
                                    <div class="col-7 pl-0 pr-2">
                                        <div id="bar_1" data-value="45" class="bar-container">
