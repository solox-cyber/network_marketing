...
<body id="kt_body" class="app-blank app-blank">
    ...
    <div class="d-flex flex-column flex-center p-6 p-lg-10 w-100">
        ...
        <div class="logo-container d-block d-lg-none mx-auto text-center" style="background-image: url('{{ asset('media/misc/auth.png') }}'); margin-bottom: -20px; background-size: cover; background-position: center;">
    <!--begin::Image-->
