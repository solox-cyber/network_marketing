...
<head>
    ...
    <meta property="og:title" content="Lern.Africa - Where Your Tech Dreams Come To Life!" />
    ...
    <script>
        ...
        channel.bind('user-register', function(data) {
            toastr.success(JSON.stringify(data.name) + ' has joined the Lern.Africa Train');
        });
    </script>
