...
<body id="kt_body" class="app-blank app-blank">
    ...
    <div class="d-flex flex-column flex-root" id="kt_app_root">
        ...
        <div class="d-flex flex-column flex-lg-row flex-column-fluid">
            <!--begin::Aside-->
           <span class="background-image-container"> <div class="d-flex flex-lg-row-fluid w-lg-50 bgi-size-cover bgi-position-center"
                style="background-image: url(media/misc/auth-bgg.png)"></span>
                <!--begin::Content-->
                <div class="d-flex flex-column flex-center p-6 p-lg-10 w-100">
                    ...
                    <!-- <img class="d-none d-lg-block mx-auto w-300px w-lg-75 w-xl-500px mb-10 mb-lg-20"
                        ...
                        <div class="logo-container d-block d-lg-none mx-auto text-center">
    <!--begin::Image-->
    <img class="w-200px" src="{{ asset('media/misc/auth.png') }}" alt="" />
    <!--end::Image-->
</div>
                    <!--end::Image-->
