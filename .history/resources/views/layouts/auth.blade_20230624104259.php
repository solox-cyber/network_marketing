...
<body id="kt_body" class="app-blank app-blank">
    ...
    <div class="d-flex flex-column flex-center p-6 p-lg-10 w-100">
        ...
        <!-- <img class="d-none d-lg-block mx-auto w-300px w-lg-75 w-xl-500px mb-10 mb-lg-20"
            ...
            <div class="logo-container d-block d-lg-none mx-auto text-center" style="background-image: url('{{ asset('media/misc/auth.png') }}'); background-size: cover; background-position: center;overflow:hidden">
    <!--begin::Image-->
    <img class="w-900px h-200px" src="{{ asset('media/misc/auth.png') }}" alt="" />
    <!--end::Image-->
</div>
