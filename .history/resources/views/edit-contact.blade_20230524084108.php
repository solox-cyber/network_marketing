 ...
 <div class="col-xl-6">
        ...
        <div class="card card-flush h-lg-100" id="kt_contacts_main">
            ...
            <div class="card-header pt-7" id="kt_chat_contacts_header">
                ...
                <div class="card-title">
                    <i class="ki-duotone ki-badge fs-1 me-2"><span class="path1"></span><span class="path2"></span><span class="path3"></span><span class="path4"></span><span class="path5"></span></i>            <h2>Edit Contact</h2>
                </div>
                <!--end::Card title-->
            </div>
            <!--end::Card header-->
        ...
        <!--end::Image placeholder-->
                    ...
                    <div class="row row-cols-1 row-cols-sm-2 rol-cols-md-1 row-cols-lg-2">
                        ...
                        <div class="col">
                            ...
                            <div class="fv-row mb-7">
                                ...
                                <!--begin::Input-->
                                <input type="email" class="form-control form-control-solid" name="email" value="{{ $contact->email }}" />
                                <!--end::Input-->
                            </div>
                            <!--end::Input group-->
                        ...
                        <div class="col">
                            ...
                            <div class="fv-row mb-7">
                                ...
                                <!--begin::Input-->
                                <input type="text" class="form-control form-control-solid" name="{{ $contact->phone_number }}" value="" />
                                <!--end::Input-->
                            </div>
                            <!--end::Input group-->
                        </div>
                    ...
                    <div class="row row-cols-1 row-cols-sm-2 rol-cols-md-1 row-cols-lg-2">
                        ...
                        <div class="col">
                            ...
                            <div class="fv-row mb-7">
                                ...
                                <!--begin::Input-->
                                <input type="text" class="form-control form-control-solid" name="city" value="{{ $contact->city }}" />
                                <!--end::Input-->
                            </div>
                            <!--end::Input group-->
                        </div>
                                ...
                                <div class="w-100">
                                    ...
                                    <select id="kt_ecommerce_select2_country" class="form-select form-select-solid" name="country" data-kt-ecommerce-settings-type="select2_flags" data-placeholder="Select a country">
                                        <option></option>
                                                ...
                                                Algeria                                    </option>
                                                                            <option value="AS" data-kt-select2-country="../../assets/media/flags/american-samoa.svg" >
                                                ...
                                                Anguilla                                    </option>
                                                                            <option value="AG" data-kt-select2-country="../../assets/media/flags/antigua-and-barbuda.svg" >
                                                ...
                                                Bonaire, Sint Eustatius and Saba                                    </option>
                                                                            <option value="BA" data-kt-select2-country="../../assets/media/flags/bosnia-and-herzegovina.svg" >
                                                ...
                                                Brazil                                    </option>
                                                                            <option value="IO" data-kt-select2-country="../../assets/media/flags/british-indian-ocean-territory.svg" >
                                                ...
                                                Cape Verde                                    </option>
                                                                            <option value="KY" data-kt-select2-country="../../assets/media/flags/cayman-islands.svg" >
                                                ...
                                                China                                    </option>
                                                                            <option value="CX" data-kt-select2-country="../../assets/media/flags/christmas-island.svg" >
                                                ...
                                                Curaçao                                    </option>
                                                                            <option value="CZ" data-kt-select2-country="../../assets/media/flags/czech-republic.svg" >
                                                ...
                                                Dominica                                    </option>
                                                                            <option value="DO" data-kt-select2-country="../../assets/media/flags/dominican-republic.svg" >
                                                ...
                                                El Salvador                                    </option>
                                                                            <option value="GQ" data-kt-select2-country="../../assets/media/flags/equatorial-guinea.svg" >
                                                ...
                                                Ethiopia                                    </option>
                                                                            <option value="FK" data-kt-select2-country="../../assets/media/flags/falkland-islands.svg" >
                                                ...
                                                France                                    </option>
                                                                            <option value="PF" data-kt-select2-country="../../assets/media/flags/french-polynesia.svg" >
                                                ...
                                                Malta                                    </option>
                                                                            <option value="MH" data-kt-select2-country="../../assets/media/flags/marshall-island.svg" >
                    ...
                    <div class="fv-row mb-7">
                        ...
                        <!--begin::Input-->
                        <textarea class="form-control form-control-solid" name="notes">{{ $contact->notes }}</textarea>
                        <!--end::Input-->
                    </div>
                    <!--end::Input group-->
