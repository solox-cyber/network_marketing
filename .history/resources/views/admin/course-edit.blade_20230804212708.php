                            ...
                            <form action="{{ route('course.update', ['id' => $courses->id])  }}" class="form mb-15" method="POST" id="kt_careers_form" enctype="multipart/form-data">
                                ...
                                <!--end::Input group-->
                                 ...
                                 <div class="row mb-5">
                                    ...
                                    <div class="col-md-12 fv-row">
                                        <!--begin::Label-->
                                        <label class="required fs-5 fw-semibold mb-2">Banner Page Image</label>
                                        <!--end::Label-->
                                        @if ($courses->profilePicture)
                                        <img src="{{ asset('storage/' . str_replace('public/', '', $courses->profilePicture->path)) }}" height="50" width="50" alt="Course Logo">
                                        @endif
                                        <!--begin::Input-->
