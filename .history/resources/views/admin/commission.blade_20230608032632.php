...
<div class="d-flex flex-column  justify-content-center flex-lg-row">
    <!--begin::Sidebar-->
    <div class="flex-column flex-lg-row-auto  align-items-center w-lg-450px w-xl-450px mb-10">
            ...
            <div class="pb-5 fs-6">
                    ...
                    <a href="#" class="btn btn-light btn-active-light-primary btn-flex btn-center btn-sm" data-kt-menu-trigger="click" data-kt-menu-placement="bottom-end">
                                        ...
                                        <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4" data-kt-menu="true">
                                            ...
                                            <form action="{{ route('walletstatement.progress', ['id' => $walletStatement->id]) }}" method="POST">
                                                    @csrf
                                                    @method('PATCH')
                                            ...
                                            <!--begin::Menu item-->
                                            <div class="menu-item px-3">
                                            <form action="{{ route('walletstatement.paid', ['id' => $walletStatement->id]) }}" method="POST">
    @csrf
    @method('PATCH')
    <button type="submit" class="menu-link px-3" style="background-color: transparent; border-color: transparent;">
        Mark as 'Paid'
