<div class="row g-7">
    ...
    <div class="ms-4 d-flex align-items-center flex-fill">
        <a href="{{ $contact->link }}" class="fs-6 fw-bold text-gray-900 text-hover-primary mb-2 me-2 flex-fill">{{ $contact->name }}</a><br>
        <a href="{{ $contact->link }}" class="fs-6 fw-bold text-gray-900 text-hover-primary mb-2 me-2 flex-fill">{{ $contact->phone }}</a>
    </div>
</div>
