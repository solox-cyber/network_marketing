                            ...
                            <form action="{{ route('courses.store') }}" class="form mb-15" method="POST" id="kt_careers_form" enctype="multipart/form-data">
                                ...
                                <div class="row mb-5">
                                    ...
                                    <div class="col-md-6 fv-row">
                                        <!--begin::Label-->
                                        <label class="required fs-5 fw-semibold mb-2">Admin Name</label>
                                        <!--end::Label-->
                                    ...
                                    <div class="col-md-6 fv-row">
                                        <!--begin::Label-->
                                        <label class="required fs-5 fw-semibold mb-2"> Fee</label>
                                        <!--end::Label-->
                                ...
                                <div class="row mb-5">
                                    ...
                                    <div class="col-md-12 fv-row">
                                        ...
                                        <textarea class="form-control form-control-solid" rows="2" name="about_course" placeholder=""></textarea>
                                    </div>
                                    <!--end::Col-->
