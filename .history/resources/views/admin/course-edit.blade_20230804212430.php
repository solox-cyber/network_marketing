                        ...
                        <div class="card-body">
                            ...
                            <form action="{{ route('course.update', ['id' => $courses->id])  }}" class="form mb-15" method="POST" id="kt_careers_form" enctype="multipart/form-data">
                                ...
                                <div class="row mb-6">
                                    ...
                                    <div class="col-lg-8">
                                        ...
                                        <div class="image-input image-input-outline" data-kt-image-input="true" style="background-image: url('../assets/media/svg/avatars/blank.svg')">
                                            ...
                                            <div class="image-input-wrapper w-125px h-125px" style="background-image: url('{{ asset('storage/' . str_replace('public/', '', $courses->profilePicture->path)) }}')">
                                ...
                                <div class="row mb-6">
                                    ...
                                    <!--end::Label-->
                                    <label class="required fs-5 fw-semibold mb-2">Banner Logo</label>
                                    <!--end::Label-->
                                    <!--begin::Col-->
                                    <div class="col-lg-8">
                                        <!--begin::Image input-->
                                ...
                                <!--end::Input group-->
                                 ...
                                 <div class="row mb-5">
                                    ...
                                    <div class="col-md-12 fv-row">
                                        <!--begin::Label-->
                                        <label class="required fs-5 fw-semibold mb-2">Banner Page</label>
                                        <!--end::Label-->
                                        <!--begin::Input-->
                                        <input class="form-control form-control-solid" type="file" placeholder="" value="{{ $courses->instructor_name }}" name="instructor_name" />
                                        <!--end::Input-->
                                    </div>
                                    <!--end::Col-->
