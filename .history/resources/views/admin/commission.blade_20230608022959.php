...
<!--end::User Info-->        <!--end::Summary-->
        ...
        <div id="kt_user_view_details" class="collapse show">
            <div class="pb-5 fs-6">
                    ...
                    <div class="text-gray-600"><a href="#" class="text-gray-600 text-hover-primary">{{$user->phone_number}}</a></div>
                    <!--begin::Details item-->
                                    <!--begin::Details item-->
                    <div class="fw-bold mt-5">Address</div>
                    <div class="text-gray-600">{{$user->city}},<br/>{{$user->country}}</div>
                    <!--begin::Details item-->
                                    <!--begin::Details item-->
                    <div class="fw-bold mt-5">Upline</div>
                    <div class="text-gray-600">{{$user->upline}}</div>
                    <!--begin::Details item-->
                      <!--begin::Details item-->
                    <div class="fw-bold mt-5">Date of Registration</div>
                    <div class="text-gray-600">  {{ date('d M Y, h:i a', strtotime($user->created_at)) }}</div>
                    <!--begin::Details item-->
                     <!--begin::Details item-->
                    <div class="fw-bold mt-5">Course Selected</div>
                    <div class="text-gray-600">{{$user->service}}</div>
                    <!--begin::Details item-->
                                    <!--begin::Details item-->
                    <div class="fw-bold mt-5">Payment Expiry Date</div>
                    <div class="text-gray-600">20 Jun 2023, 11:05 am</div>
                    <!--begin::Details item-->
                            </div>
        </div>
        <!--end::Details content-->
        ...
        <div class="table-responsive">
            ...
            <table class="table align-middle table-row-dashed fw-semibold text-gray-600 fs-6 gy-5" id="kt_table_users_logs">
                <tbody>
                            ...
                            <td>
                               POST /v1/customer/c_6463681b375d3/not_found                            </td>
                            ...
                            <td>
                               POST /v1/invoice/in_4139_6196/invalid                            </td>
                            <td class="pe-0 text-end min-w-200px">
                            ...
                            <td>
                               POST /v1/customer/c_6463681b375d2/not_found                            </td>
                            <td class="pe-0 text-end min-w-200px">
                            ...
                            <td>
                               POST /v1/invoices/in_9150_7020/payment                            </td>
                            <td class="pe-0 text-end min-w-200px">
