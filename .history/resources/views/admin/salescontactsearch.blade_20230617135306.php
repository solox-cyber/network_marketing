        ...
        <div class="card-header border-0 pt-6">
            ...
            <div class="card-title">
                ...
                <div class="d-flex align-items-center position-relative my-2">
                    ...
                    <input type="text" data-kt-user-table-filter="search" class="form-control form-control-solid w-250px ps-13" placeholder="Search contact" />
                </div>
                <!--end::Search-->
                ...
                <form action="{{ route('contacts.assign') }}" method="POST">
                    ...
                    <div class="d-flex align-items-center">
                        ...
                        <!-- Button -->
                        <button type="submit" class="btn btn-primary ms-3 flex-grow-1">Reassign Contacts</button>
                        <!-- End Button -->
                    </div>
