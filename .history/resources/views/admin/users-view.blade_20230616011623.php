...
<div class="card mb-5 mb-xl-10" id="kt_profile_details_view">
 ...
 <div class="row mb-7">
            ...
            <div class="row mb-7">
                ...
                <!--begin::Col-->
                <div class="col-lg-8">
                    <span class="fw-bold fs-6 text-gray-800">{{ $user->serial_number }}</span>
                </div>
                <!--end::Col-->
            </div>
            <!--end::Input group-->
            ...
            <div class="row mb-7">
                <!--begin::Label-->
                <label class="col-lg-4 fw-semibold text-muted">City/Country</label>
                <!--end::Label-->
                <!--begin::Col-->
                <div class="col-lg-8">
                    <span class="fw-bold fs-6 text-gray-800">{{ $user->city }},{{ $user->country }} </span>
                </div>
                <!--end::Col-->
            </div>
            <!--end::Row-->
            ...
            <div class="row mb-7">
                ...
                <div class="col-lg-8 fv-row">
                    <span class="fw-semibold text-gray-800 fs-6"> @if (isset($courseDetails[$contact->id]))
