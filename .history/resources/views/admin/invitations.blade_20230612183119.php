...
<div class="app-main flex-column flex-row-fluid" id="kt_app_main">
 ...
 <div class="d-flex align-items-center">
    <!-- Select -->
    <select name="sales_rep_id" id="sales_rep_id" class="form-select form-select-transparent text-dark fs-7 lh-1 fw-bold py-0 ps-3 w-auto" data-control="select2" data-hide-search="true" data-dropdown-css-class="w-150px" data-placeholder="Select an option" data-kt-table-widget-4="filter_status">
        <option></option>
    ...
    <!-- Button -->
    <button type="submit" class="btn btn-primary ms-3">Assign Contacts</button>
    <!-- End Button -->
</div>
