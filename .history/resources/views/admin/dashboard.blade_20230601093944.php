@extends('admin.admin_layouts.dash')
                        ...
                        <div class="card card-flush bgi-no-repeat bgi-size-contain bgi-position-x-end h-md-50 mb-5 mb-xl-10" style="background-color: #3E97FF;background-image:url('assets/media/svg/shapes/widget-bg-1.png')">
                            ...
                            <div class="card-header pt-5">
                                ...
                                <div class="card-title d-flex flex-column">
                                    ...
                                    <!-- begin::Service -->
                                    <span class="fs-1hx fw-bold mt-3 text-white me-2 lh-1 ls-n2">
                            ...
                            <div class="card-body d-flex align-items-end pt-0">
                                ...
                                <div class="d-flex align-items-center flex-column mt-3 w-100">
                                    ...
                                    <div class="h-8px mx-3 w-100 bg-white bg-opacity-50 rounded">
                                        <div class="bg-white rounded h-8px" role="progressbar" style="width: 30;" aria-valuenow="50" aria-valuemin="0" aria-valuemax="100"></div>
                                    </div>
                                </div>
                                <!--end::Progress -->
                            </div>
                        ...
                        <div class="card card-flush h-lg-50">
                            ...
                            <div class="card-body pt-5">
                                ...
                                <div class="d-flex flex-stack">
                                    ...
                                    <!--end::Section-->
                                   <h1>uruubuuut</h1> {{Auth::guard('admin')->user()->name
}}
