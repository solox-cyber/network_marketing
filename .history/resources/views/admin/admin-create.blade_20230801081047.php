                            ...
                            <form action="{{ route('admin.store') }}" class="form mb-15" method="POST" id="kt_careers_form" enctype="multipart/form-data">
                                ...
                                <!--end::Input group-->
                                    ...
                                    <div class="col-md-12 fv-row">
                                        ...
                                        <!--begin::Input-->
                                        <select name="usertype" aria-label="Select a" data-control="select2" data-placeholder="Select a course..." class="form-select form-select-solid form-select-lg fw-semibold">
                        <option> </option>
                                        </select>
                                        <!--end::Input-->
                                        @error('name')
