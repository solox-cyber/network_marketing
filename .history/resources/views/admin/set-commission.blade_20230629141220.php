                ...
                <div class="d-flex flex-column flex-xl-row">
                    ...
                    <div class="card bg-body me-xl-12 mb-9 mb-xl-0">
                        <div class="card-body">
                            ...
                            <!--begin::Form-->
                            <form action="{{ route('commission.store') }}" class="form mb-15" method="POST" id="kt_careers_form" enctype="multipart/form-data">
                                @csrf
                                ...
                                <div class="row mb-5">
                                    ...
                                    <div class="col-md-12 fv-row">
                                        ...
                                        <!--begin::Input-->
                                        <input class="form-control form-control-solid" type="text" placeholder="" name="commission_percentage" />
                                        <!--end::Input-->
                                        @error('name')
