...
php
Copy code
Route::get('/assign-contacts', [ContactController::class, 'showAssignContacts'])->name('contacts.assign.show');
Route::post('/assign-contacts', [ContactController::class, 'assignContacts'])->name('contacts.assign');
Make sure to adjust the route paths and names as per your application's routing conventions. Also, consider adding appropriate styling and validation as per your requirements.
                                    ...
                                    <tr class="text-start text-muted fw-bold fs-7 text-uppercase gs-0">
                                        <th class="w-10px pe-2">
                                            <div class="form-check form-check-sm form-check-custom form-check-solid me-3">
                                                <input class="form-check-input" name="contact_ids[]" type="checkbox" data-kt-check="true" value="{{$contact->id}}" />
                                            </div>
                                        </th>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="form-check form-check-sm form-check-custom form-check-solid">
                                                <input class="form-check-input" type="checkbox" name="contact_id" value=" {{ $contact->id }}" />
                                            </div>
                                        </td>
