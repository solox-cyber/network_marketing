                                        ...
                                        <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4" data-kt-menu="true">
                                            ...
                                            <div class="menu-item px-3">
                                                <form action="{{ route('admin.destroy', ['id' => $contact->id]) }}" method="POST">
                                                    @csrf
                                                    @method('DELETE')
                                                    <button type="submit" class="menu-link px-3" onclick="return confirm('Are you sure you want to delete this admin?')" style="background-color: transparent; border-color: transparent;">
                                                        Delete
                                                    </button>
                                                </form>
                                            </div>
