                                        ...
                                        <div class="menu-item px-3">
                                            <div class="menu-content d-flex align-items-center px-3">
                                                ...
                                                <div class="symbol symbol-50px me-5">
                                                    ...
                                                    <div style="width:100%;height:100%;font-size:20px;font-weight:bold">{{ substr(Auth::admin()->name, 0, 1) }}</div>
...
Method Illuminate\Auth\SessionGuard::admin does not exist. (View: C:\Users\USER\Documents\basic\resources\views\admin\admin_includes\headbar.blade.php)
http://127.0.0.1:8000/admin/dashboard
                                        ...
                                        <!--begin::Menu item-->
                                        <div class="menu-item px-5">
                                            <a href="{{route('statement')}}" class="menu-link px-5">
                                                My Statements
                                            </a>
                                        </div>
                                        <!--end::Menu item-->
