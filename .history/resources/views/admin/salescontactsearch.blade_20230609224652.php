...
<div class="col-lg-4 col-xl-4">
    ...
    <div class="card card-flush" id="kt_contacts_list">
        ...
        <div class="card-header pt-7" id="kt_contacts_list_header">
            <!--begin::Form-->
<form id="searchForm" class="d-flex align-items-center position-relative w-100 m-0" autocomplete="off">
    @csrf
    <i class="ki-duotone ki-magnifier fs-3 text-gray-500 position-absolute top-50 ms-5 translate-middle-y">
        <span class="path1"></span>
        <span class="path2"></span>
    </i>
    <input type="text" class="form-control form-control-solid ps-13" id="searchInput" name="search" placeholder="Search contacts">
</form>
<!--end::Form-->
