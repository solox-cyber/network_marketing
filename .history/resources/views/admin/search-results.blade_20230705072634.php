                        ...
                        <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_table_users">
                            ...
                            <tbody class="text-gray-600 fw-semibold">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        @if (isset($salesDetails[$user->id]))
                                        <p>{{ $salesDetails[$user->id]['name'] }}</p>
                                        @else
                                    ...
                                    <td>
                                        ...
                                        @if (isset($courseDetails[$user->id]))
                                        <p>{{ $courseDetails[$user->id]['course_name'] }}</p>
                                        @else
                                    ...
                                    <td class="text-end">
                                        ...
                                        <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4" data-kt-menu="true">
                                            ...
                                            <div class="menu-item px-3">
                                                <a href="{{ route('userview', ['id' => $user->id]) }}" class="menu-link px-3">
                                                    View
                                                </a>
                                            </div>
                                            <!--end::Menu item-->
                                            ...
                                            <!--begin::Menu item-->
                                            <div class="menu-item px-3">
                                                <form action="{{ route('users.deactivate', ['id' => $user->id]) }}" method="POST">
                                                    @csrf
                                                    @method('POST')
                                            ...
                                            <!--begin::Menu item-->
                                            <div class="menu-item px-3">
                                                <form action="{{ route('users.activate', ['id' => $user->id]) }}" method="POST">
                                                    @csrf
                                                    @method('POST')
