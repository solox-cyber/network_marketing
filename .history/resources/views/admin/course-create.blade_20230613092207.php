...
<div class="app-main flex-column flex-row-fluid" id="kt_app_main">
                            ...
                            <form action="#" class="form mb-15" method="post" id="kt_careers_form">
                                ...
                                <div class="row mb-5">
                                    ...
                                    <div class="col-md-12 fv-row">
                                        ...
                                        <!--begin::Input-->
                                        <input class="form-control form-control-solid" type="date" placeholder="" name="date" />
                                        <!--end::Input-->
                                    </div>
                                    <!--end::Col-->
 ...
 <div class="col-md-6 fv-row">
                                        <!--begin::Label-->
                                        <label class="required fs-5 fw-semibold mb-2">Instructor I</label>
                                        <!--end::Label-->
                                ...
                                <div class="d-flex flex-column mb-5">
                                    <label class="fs-6 fw-semibold mb-2">Instructor Bio</label>
