                                        ...
                                        <div class="menu-item px-3">
                                            <div class="menu-content d-flex align-items-center px-3">
                                                ...
                                                <!-- {{ storage('path/to/image.jpg') }} -->
                                                    ...
                                                    <img alt="Logo" src="{{ asset('storage/profile_pictures/PreKBqfxQmpIPZCUrXYmsPsxE7kMgHtGTYUbcQMl.jpg') }}" />
                                                    @else
                                                    <!-- Display a default profile picture if no profile picture is set -->
                                                    <img src="{{ asset('path/to/default/profile-picture.jpg') }}" alt="Default Profile Picture" width="100" height="100">
                                                    @endif
