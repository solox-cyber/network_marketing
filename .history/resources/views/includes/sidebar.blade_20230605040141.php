            ...
            <!--end::Menu item-->
             ...
             <span class="menu-link"><span class="menu-icon"><i class="ki-duotone ki-abstract-25 fs-2"><span class="path1"></span><span class="path2"></span></i></span><span class="menu-title">Com</span></span>
            <!--begin::Menu item-->
            <div class="menu-item">
