                            ...
                            <div class="app-navbar flex-shrink-0">
                                ...
                                <div class="app-navbar-item ms-2 ms-1 ms-lg-3" id="kt_header_user_menu_toggle">
                                    ...
                                    <div class="cursor-pointer symbol symbol-35px symbol-md-40px" data-kt-menu-trigger="{default: 'click', lg: 'hover'}" data-kt-menu-attach="parent" data-kt-menu-placement="bottom-end">
                                        ...
                                        <img src="{{ substr(Auth::user()->name, 0, 1) }}" alt="default" />
                                        <div class="image-input-wrapper w-100px h-100px" style="background-image: url({{ substr($Auth::user()->name, 0, 1) }})"></div>
                                        @endif
                                        ...
                                        <div class="menu-item px-3">
                                            <div class="menu-content d-flex align-items-center px-3">
                                                ...
                                                <div class="symbol symbol-50px me-5">
                                                    ...
                                                    <img src="{{ substr(Auth::user()->name, 0, 1) }}" alt="Default Profile Picture" width="100" height="100">
                                                    @endif
