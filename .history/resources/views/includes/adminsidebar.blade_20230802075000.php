            ...
            " id="#kt_app_sidebar_menu" data-kt-menu="true" data-kt-menu-expand="false">
                                ...
                                <div data-kt-menu-trigger="click" class="menu-item here show menu-accordion">
                                    ...
                                    @if(Auth::user()->usertype !== 'subadmin'Auth::user()->usertype !== 'subadmin' && Auth::user()->upline === '0')
                                ...
                                @if(Auth::user()->usertype !== 'admin' || Auth::user()->usertype !== 'subadmin' || Auth::user()->upline === '1')
