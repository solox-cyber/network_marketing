...
" id="kt_app_header_menu" data-kt-menu="true">
                            ...
                            <div class="app-navbar flex-shrink-0">
                                ...
                                <div class="app-navbar-item ms-2 ms-1 ms-lg-3" id="kt_header_user_menu_toggle">
                                    ...
                                    {{ asset('storage/' . Auth::user()->profilePicture->path) }}
    <img src="{{ asset('storage/' . Auth::user()->profilePicture->path) }}" alt="user" />
    <img src="{{ url('storage/profile_pictures/QNak8TK5PC8BEOFBad2PDFwLseXjfwlCgGiKuKvx.jpg') }}" alt="user" />
@else
    <!-- Display a default image or placeholder if the user doesn't have a profile picture -->
    <img src="{{ asset('path/to/default/image.jpg') }}" alt="default" />
@endif
                                        ...
                                        <div class="menu-item px-3">
                                            <div class="menu-content d-flex align-items-center px-3">
                                                ...
                                                <div class="symbol symbol-50px me-5">
                                                    ...
                                                    @if(Auth::user()->profilePicture)
                                                    <img alt="Logo" src="{{ asset('storage/' . Auth::user()->profilePicture->path) }}" />
                                                  
                                                    @else
                                                    <!-- Display a default profile picture if no profile picture is set -->
                                                    <img src="{{ asset('storage/profile_pictures/') }}" alt="Default Profile Picture" width="100" height="100">
                                                    @endif
