            ...
            <!--end::Menu item-->
            <span class="menu-link"><span class="menu-icon"><i class="ki-duotone ki-educare fs-2"><span class="path1"></span><span class="path2"></span><span class="path3"></span><span class="path4"></span></i></span><span class="menu-title">Account</span><span class="menu-arrow"></span></span>
            ...
            <!--end::Menu item-->
              ...
              <div class="menu-item">
                <a href="{{route('setting')}}" class="menu-link py-3 {{ set_active_route('setting') }}">
                    ...
                    <span class="menu-title">Add Account Details</span>
