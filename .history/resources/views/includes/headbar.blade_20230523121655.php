...
" id="kt_app_header_menu" data-kt-menu="true">
    ...
    <img src="{{ asset('storage/' . Auth::user()->profilePicture->path) }}" class="rounded-circle me-5" alt="Profile Picture" width="100" height="100">
@else
    <!-- Display a default profile picture if no profile picture is set -->
    <img src="{{ asset('path/to/default/profile-picture.jpg') }}" class="rounded-circle me-5" alt="Default Profile Picture" width="100" height="100">
@endif
