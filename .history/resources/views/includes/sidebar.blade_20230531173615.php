            ...
            " id="#kt_app_sidebar_menu" data-kt-menu="true" data-kt-menu-expand="false">
                              ...
                              <!--begin::Menu item-->
            <div class="menu-item {{ set_active_route('dashboard') }}">
                <a href="#" class="menu-link py-3">
                    <span class="menu-bullet">
                        <span class="bullet bullet-dot"></span>
                    </span>
                    <span class="menu-title">Example Link</span>
                    <a class="menu-link  " href="{{route('dashboard')}}"><span class="menu-bullet"><span class="bullet bullet-dot"></span></span><span class="menu-title">Home</span></a><!--end:Menu link--></div>
                                        <!--end:Menu item-->
                </a>
            </div>
            <!--end::Menu item-->
