            ...
            <span class="menu-link"><span class="menu-icon"><i class="ki-duotone ki-educare fs-2"><span class="path1"></span><span class="path2"></span><span class="path3"></span><span class="path4"></span></i></span><span class="menu-title">Account</span></span>
             ...
             <!--begin::Menu item-->
             <div class="menu-item">
                <a href="" class="menu-link py-3 {{ set_active_route('overview') }}">
                    <span class="menu-bullet">
                        <span class="bullet bullet-dot"></span>
                    </span>
            ...
            <!--end::Menu item-->
             ...
             <!--begin::Menu item-->
             <div class="menu-item">
                <a href="" class="menu-link py-3 {{ set_active_route('statement') }}">
                    <span class="menu-bullet">
                        <span class="bullet bullet-dot"></span>
                    </span>
            ...
            <!--end::Menu item-->
             ...
             <!--begin::Menu item-->
             <div class="menu-item">
                <a href="" class="menu-link py-3 {{ set_active_route('payout') }}">
                    <span class="menu-bullet">
                        <span class="bullet bullet-dot"></span>
                    </span>
            ...
            <!--end::Menu item-->
              <!--begin::Menu item-->
              <div class="menu-item">
                <a href="" class="menu-link py-3 {{ set_active_route('setting') }}">
                    <span class="menu-bullet">
                        <span class="bullet bullet-dot"></span>
                    </span>
            ...
            <!--begin::Menu item-->
            <div class="menu-item">
                <a href="" class="menu-link py-3 {{ set_active_route('myCourses') }}">
                    <span class="menu-bullet">
                        <span class="bullet bullet-dot"></span>
                    </span>
            ...
            <!--begin::Menu item-->
            <div class="menu-item">
                <a href="" class="menu-link py-3 {{ set_active_route('add_contact') }}">
                    <span class="menu-bullet">
                        <span class="bullet bullet-dot"></span>
                    </span>
