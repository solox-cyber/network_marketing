            ...
            <!--end::Menu item-->
             <!--begin::Menu item-->
             <div class="menu-item">
                <a href="{{ set_active_route('setting') }}" class="menu-link py-3 {{ set_active_route('setting') }}">
                    <span class="menu-bullet">
                        <span class="bullet bullet-dot"></span>
                    </span>
            ...
            <!--end::Menu item-->
             <!--begin::Menu item-->
             <div class="menu-item">
                <a href="{{ set_active_route('statement') }}" class="menu-link py-3 {{ set_active_route('statement') }}">
                    <span class="menu-bullet">
                        <span class="bullet bullet-dot"></span>
                    </span>
            ...
            <!--end::Menu item-->
             <!--begin::Menu item-->
             <div class="menu-item">
                <a href="{{ set_active_route('payout') }}" class="menu-link py-3 {{ set_active_route('payout') }}">
                    <span class="menu-bullet">
                        <span class="bullet bullet-dot">Request Payout</span>
                    </span>
            ...
            <div class="menu-item">
                <a href="{{ set_active_route('payout') }}" class="menu-link py-3 {{ set_active_route('payout') }}">
                    <span class="menu-bullet">
                        <span class="bullet bullet-dot">Add Account Details</span>
                    </span>
                    <span class="menu-title">Payout</span>
            ...
            <!--end::Menu item-->
                                ...
                                <div data-kt-menu-trigger="click" class="menu-item menu-accordion">
                                    ...
                                    <div class="menu-sub menu-sub-accordion"><!--begin:Menu item-->
                                        <div class="menu-item"><!--begin:Menu link--><a class="menu-link  " href="{{route('overview')}}"><span class="menu-bullet"><span class="bullet bullet-dot"></span></span><span class="menu-title">Overview</span></a><!--end:Menu link--></div>
                                        ...
                                        <!--end:Menu item-->
                                        <!--begin:Menu item-->
                                        <div class="menu-item"><!--begin:Menu link--><a class="menu-link {{ set_active_route('statement') }}" href="{{route('statement')}}"><span class="menu-bullet"><span class="bullet bullet-dot"></span></span><span class="menu-title">Statement</span></a><!--end:Menu link--></div>
                                        <!--end:Menu item-->
                                        <!--begin:Menu item-->
