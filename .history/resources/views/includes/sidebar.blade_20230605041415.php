            ...
            <span class="menu-link"><span class="menu-icon"><i class="ki-duotone ki-abstract-25 fs-2"><span class="path1"></span><span class="path2"></span></i></span><span class="menu-title">Sales Rep</span></span>
            <!--begin::Menu item-->
            <div class="menu-item">
                <a href="{{route('add_contact')}}" class="menu-link py-3 {{ set_active_route('add_contact') }}">
                    <span class="menu-bullet">
 ...
 <div class="menu-item">
                <a href="{{route('add_contact')}}" class="menu-link py-3 {{ set_active_route('add_contact') }}">
                    ...
                    <span class="menu-title">View Sales Reps</span>
