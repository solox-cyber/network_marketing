                ...
                <div id="kt_app_sidebar" class="app-sidebar  flex-column " data-kt-drawer="true" data-kt-drawer-name="app-sidebar" data-kt-drawer-activate="{default: true, lg: false}" data-kt-drawer-overlay="true" data-kt-drawer-width="225px" data-kt-drawer-direction="start" data-kt-drawer-toggle="#kt_app_sidebar_mobile_toggle">
                    ...
                    <div class="app-sidebar-logo px-6" id="kt_app_sidebar_logo">
                        <!--begin::Logo image-->
                        <a href="index.html">
                        <img alt="Logo" src="{{asset('media/logos/lern-logo.png')}}" class="h-60px app-sidebar-logo-default" />
                        </a>
                        <!--end::Logo image-->
...
<!--begin::Menu item-->
<div class="menu-item">
    <a href="{{route('overview')}}" class="menu-link py-3 {{ set_active_route('overview') }}" disabled>
        <span class="menu-bullet">
            <span class="bullet bullet-dot"></span>
        </span>
...
<!--begin::Menu item-->
<div class="menu-item">
    <a href="{{route('statement')}}" class="menu-link py-3 {{ set_active_route('statement') }}" disabled>
        <span class="menu-bullet">
            <span class="bullet bullet-dot"></span>
        </span>
...
<!--begin::Menu item-->
<div class="menu-item">
    <a href="{{route('payout')}}" class="menu-link py-3 {{ set_active_route('payout') }}" disabled>
        <span class="menu-bullet">
            <span class="bullet bullet-dot"></span>
        </span>
...
<!--begin::Menu item-->
<div class="menu-item">
    <a href="{{route('setting')}}" class="menu-link py-3 {{ set_active_route('setting') }}" disabled>
        <span class="menu-bullet">
            <span class="bullet bullet-dot"></span>
        </span>
...
<!--begin::Menu item-->
<div class="menu-item">
    <a href="{{route('myCourses')}}" class="menu-link py-3 {{ set_active_route('myCourses') }}" disabled>
        <span class="menu-bullet">
            <span class="bullet bullet-dot"></span>
        </span>
...
<!--begin::Menu item-->
<div class="menu-item">
    <a href="{{route('add_contact')}}" class="menu-link py-3 {{ set_active_route('add_contact') }}" disabled>
        <span class="menu-bullet">
            <span class="bullet bullet-dot"></span>
        </span>
