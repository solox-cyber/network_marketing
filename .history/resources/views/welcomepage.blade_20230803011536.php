            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-8 navbar pt-0 pb-0">
                        <a href="/"><h1 class="fredoka-font ls-3 fw-700 text-current font-xxl">Elomoas <a href="/">
  <img alt="Logo" src="{{asset('media/logos/lern-logo.png')}}" class="img-fluid h-20px app-sidebar-logo-default" />
</a>
</h1></a>
