    ...
    <div class="step">
        ...
        <span class="step-label">Certificate</span>
                    ...
                    <div class="col-xxl-6">
                        ...
                        @if ($$profile_picture = $course->profilePicture;)
                    <img src="{{ asset('storage/' . str_replace('public/', '', $profile_picture->path)) }}" alt="image" class="p-3" alt="Course Logo" style="height:60px!important;width:60px!important">
                @endif
                                            </div>
