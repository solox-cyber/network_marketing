                        ...
                        <div class="contact-wrap bg-white shadow-lg rounded-lg position-relative top-0">
                            ...
                            <form action="{{ route('contact.submit') }}" method="POST">
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-12">
                                        <div class="form-group mb-3">
                                            <input type="text" name="phone_number" class="form-control style2-input bg-color-none text-grey-700" placeholder="Email">
                                        </div>
                                    </div>
...
<option></option>
                                    ...
                                    <div class="col-12">
                                        <div class="form-group mb-3 md-mb-2">
                                            <textarea name="message" class="w-100 h125 style2-textarea p-3 form-control"placeholder="Let's us know"></textarea>
                                        </div>
