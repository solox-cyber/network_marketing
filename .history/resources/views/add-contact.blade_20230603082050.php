                    ...
                    <div class="card card-flush h-lg-100" id="kt_contacts_main">
                        ...
                        <div class="card-body pt-5">
                            <!--begin::Form-->
                                    ...
                                    <div class="row row-cols-1 row-cols-sm-2 rol-cols-md-1 row-cols-lg-3">
                                        ...
                                        <div class="col">
                                            ...
                                            <div class="fv-row mb-7">
                                                ...
                                                <!--begin::Input-->
                                                <input type="name" class="form-control form-control-solid" name="name" value="{{ old('name') }}" />
                                                <!--end::Input-->
                                            </div>
                                            <!--end::Input group-->
                                        ...
                                        <div class="col">
                                            ...
                                            <div class="fv-row mb-7">
                                                ...
                                                <!--begin::Input-->
                                                <input type="text" class="form-control form-control-solid" name="phone_number" value="{{ old('phone_number') }}" required />
                                                <!--end::Input-->
                                            </div>
                                            <!--end::Input group-->
                                        </div>
                                    ...
                                    <div class="row row-cols-1 row-cols-sm-2 rol-cols-md-1 row-cols-lg-3">
                                        ...
                                        <div class="col">
                                            ...
                                            <div class="fv-row mb-7">
                                                ...
                                                <!--begin::Input-->
                                                <input type="text" class="form-control form-control-solid" name="phone_number" value="{{ old('phone') }}" required />
                                                <!--end::Input-->
                                            </div>
                                            <!--end::Input group-->
                                        </div>
                                ...
                                <div class="separator mb-6"></div>
                                <!--end::Separator-->
                                <form class="form" action="{{ route('contact.add') }}" id="formFields" method="POST" enctype="multipart/form-data">
                                @csrf
                                ...
                                <div class="d-flex justify-content-end">
                                    ...
                                    <button href="{{route('add_contact')}}" type="button" onclick="addFormField()" class="btn btn-primary w-100">
