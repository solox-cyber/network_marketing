        ...
        <form action="{{ route('profile.update') }}" method="POST" enctype="multipart/form-data" class="form">
            ...
            <div class="card-body border-top p-9">
                ...
                <div class="row mb-6">
                    ...
                    <!--begin::Col-->
                    <div class="col-lg-8 fv-row">
                        <input type="text" name="account_name" class="form-control form-control-lg form-control-solid" placeholder="account_name" value="{{ Auth::user()->account_name }}" />
                    </div>
                    <!--end::Col-->
                </div>
                <!--end::Input group-->
                  ...
                  <div class="row mb-6">
                    ...
                    <!--begin::Col-->
                    <div class="col-lg-8 fv-row">
                        <input type="text" name="account_number" class="form-control form-control-lg form-control-solid" placeholder="account_number" value="{{ Auth::user()->account_name }}" />
                    </div>
                    <!--end::Col-->
                </div>
                <!--end::Input group-->
                ...
                <div class="row mb-6">
                    ...
                    <label class="col-lg-4 col-form-label fw-semibold fs-6">
                        ...
                        <span class="ms-1" data-bs-toggle="tooltip" title="Account number must be active">
                            <i class="ki-duotone ki-information-5 text-gray-500 fs-6"><span class="path1"></span><span class="path2"></span><span class="path3"></span></i></span> </label>
                    <!--end::Label-->

                    <!--begin::Col-->
                    <div class="col-lg-8 fv-row">
                        <input type="text" name="account_number" class="form-control form-control-lg form-control-solid" placeholder="account_number" value="{{ Auth::user()->account_number }}" />
                    </div>
                    <!--end::Col-->
                </div>
                <!--end::Input group-->
