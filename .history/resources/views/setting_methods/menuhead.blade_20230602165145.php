    ...
    <div class="d-flex flex-column flex-column-fluid">
        ...
        <div id="kt_app_toolbar" class="app-toolbar  py-3 py-lg-6 ">
            ...
            <div id="kt_app_toolbar_container" class="app-container  container-xxl d-flex flex-stack ">
                ...
                <div class="symbol symbol-65px symbol-lg-100px symbol-fixed position-relative mt-n3">
                    ...
                    <div class="position-absolute translate-middle bottom-0 start-100 ms-n2 mb-6 bg-success rounded-circle h-25px w-25px"></div>
                    <!--begin::Name-->
