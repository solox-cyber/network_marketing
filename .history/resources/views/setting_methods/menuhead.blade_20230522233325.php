...
<div class="card card-flush mb-9" id="kt_user_profile_panel">
            ...
            <img src="{{ asset('storage/uploads/profile_pictures/' . Auth::user()->profilePicture->path) }}" alt="Profile Picture" class="border border-white border-4" style="border-radius: 20px;">
        @else
