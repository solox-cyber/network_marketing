        ...
        <div class="card-body border-top p-9">
            ...
            <div class="d-flex flex-wrap align-items-center mb-10">
                ...
                <div id="kt_signin_password_button" class="ms-auto">
                    <button class="btn btn-light btn-active-light-primary" kt_signin_password_editdata-bs-toggle="modal" data-bs-target="#kt_modal_two_factor_authentication">Reset Password</button>
                </div>
                <!--end::Action-->
            </div>
            <!--end::Password-->
