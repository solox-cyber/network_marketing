            ...
            <div id="kt_app_content_container" class="app-container  container-xxl ">
                ...
                <div class="d-flex flex-wrap flex-stack my-5">
                    ...
                    <div class="d-flex flex-wrap my-1">
                        ...
                        <div class="m-0">
                            <a href="{{route('allCourses')}}" class="btn btn-primary">Add New Course</a>
                            <!--begin::Select-->
                            <!-- <select name="status" data-control="select2" data-hide-search="true" class="form-select form-select-sm bg-body border-body fw-bold w-125px">
                                <option value="Active" selected>All Courses</option>
...
<div class="col-md-6 col-xl-4">
    ...
    <span class="card border-hover-primary">
        ...
        <div class="card-body p-9">
            ...
            <!--begin::Button-->
            <a href="ri" class="btn btn-primary">Details</a>
            <!--end::Button-->
        </div>
        <!--end:: Card body-->
    </span>
