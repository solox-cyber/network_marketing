                ...
                <div class="d-flex flex-stack py-4">
                    ...
                    <div class="d-flex align-items-center">
                        ...
                        <div class="ms-4">
                            ...
                            <!-- <div class="fs-6">
                               <a href="{{ route('edit_contact', ['contact' => $contact->id]) }}" class="btn btn-sm">Edit Contact</a>
                               <a href="{{ route('contacts.show', ['contact' => $contact->id]) }}" class="btn btn-sm btn-danger">View Contact</a>
                            </div> -->
                        </div>
                        <!--end::Details-->
                        <a href="{{ route('edit_contact', ['contact' => $contact->id]) }}" class="btn btn-sm btn-danger">Edit Contact</a>
                    </div>
                    <!--end::Details-->
                </div>
                <!--end::User-->
