...
<div class="col-lg-4 col-xl-4">
    ...
    <div class="card card-flush" id="kt_contacts_list">
        ...
        <div class="card-header pt-7" id="kt_contacts_list_header">
            <!--begin::Form-->
            <form class="d-flex align-items-center position-relative w-100 m-0" method="POST" action="{{route('contact.searc')}}" autocomplete="off">
                <!--begin::Icon-->
                ...
                <div class="d-flex flex-stack py-4">
                    ...
                    <div class="d-flex align-items-center w-100">
                        ...
                        <div class="ms-4 d-flex align-items-center flex-fill">
                            <a href="{{ route('contacts.show',['contact' => $contact->id]) }}" class="fs-6 fw-bold text-gray-900 text-hover-primary mb-2 me-2 flex-fill">{{ $contact->name }}</a>
                            <div class="fw-semibold fs-7 text-muted flex-shrink-0">
                                <a href="{{ route('edit_contact', ['contact' => $contact->id]) }}" class="btn btn-sm btn-primary me-2">Edit</a>
                            </div>
                        </div>
                        ...
                        <!-- <div class="ms-4">
                            ...
                            <div class="fw-semibold fs-7 text-muted"> <a href="{{ route('edit_contact', ['contact' => $contact->id]) }}" class="btn btn-sm btn-primary">Edit Contact</a></div>
                            <div class="fs-6">
                                <a href="{{ route('edit_contact', ['contact' => $contact->id]) }}" class="btn btn-sm btn-primary">Edit Contact</a>
                                <a href="{{ route('contacts.show', ['contact' => $contact->id]) }}" class="btn btn-sm btn-danger">View Contact</a>
                            </div>
                        </div> -->
                        <!--end::Details-->
