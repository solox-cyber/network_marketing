                ...
                <div class="d-flex flex-stack py-4">
                    ...
                    <div class="d-flex align-items-center">
                        <!--begin::Avatar--><div class="symbol  symbol-40px symbol-circle ">
                            ...
                            <img src="{{ asset('storage/public/profile_picture/hA2h0yy7OHlhSRQDSg8yxtjpiMMFS1KI7Bp3QBOE.jpg') }}" alt="Default Profile Picture" width="100" height="100">
                            <div class="symbol-badge bg-success start-100 top-100 border-4 h-15px w-15px ms-n2 mt-n2"></div></div><!--end::Avatar-->
                        <!--begin::Details-->
                        <div class="ms-4">
                            <a href="view-contact.html" class="fs-6 fw-bold text-gray-900 text-hover-primary mb-2">{{ $contact->name }}</a>
                            <div class="fw-semibold fs-7 text-muted">{{ $contact->email }}</div>
                            <div class="fs-6">
                               <a href="{{ route('contacts.edit', ['contact' => $contact->id]) }}" class="btn btn-sm">Edit Contact</a> <a href="" class="btn btn-sm btn-danger">View Contact</a>
                            </div>
                        </div>
                        <!--end::Details-->
                    </div>
