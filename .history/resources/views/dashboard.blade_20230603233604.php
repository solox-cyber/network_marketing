...
<div class="app-main flex-column flex-row-fluid" id="kt_app_main">
    ...
    <div class="col-md-3">
        <div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
            <a class="nav-link active" id="registration-tab" data-bs-toggle="pill" href="#registration" role="tab" aria-controls="registration" aria-selected="true">Registration</a>
            <a class="nav-link" id="payment-tab" data-bs-toggle="pill" href="#payment" role="tab" aria-controls="payment" aria-selected="false">Payment</a>
            <a class="nav-link" id="progress-tab" data-bs-toggle="pill" href="#progress" role="tab" aria-controls="progress" aria-selected="false">Progress</a>
            <a class="nav-link" id="certificate-tab" data-bs-toggle="pill" href="#certificate" role="tab" aria-controls="certificate" aria-selected="false">Certificate</a>
        </div>
    </div>
    <div class="col-md-9">
        <div class="tab-content" id="v-pills-tabContent">
            <div class="tab-pane fade show active" id="registration" role="tabpanel" aria-labelledby="registration-tab">
                ...
                <h3>Registration</h3>
                <p>Registration form and details...</p>
            </div>
            <div class="tab-pane fade" id="payment" role="tabpanel" aria-labelledby="payment-tab">
                <!-- Payment content goes here -->
                <h3>Payment</h3>
                <p>Payment information and options...</p>
            </div>
            <div class="tab-pane fade" id="progress" role="tabpanel" aria-labelledby="progress-tab">
                <!-- Progress content goes here -->
                <h3>Progress</h3>
                <p>Tracking progress and updates...</p>
            </div>
            <div class="tab-pane fade" id="certificate" role="tabpanel" aria-labelledby="certificate-tab">
                <!-- Certificate content goes here -->
                <h3>Certificate</h3>
                <p>Certificate generation and download...</p>
            </div>
        </div>
    </div>
</div>
