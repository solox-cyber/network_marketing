                ...
                <div class="col-xl-5">
                    ...
                    <div class="card card-flush h-lg-100" id="kt_contacts_main">
                        ...
                        <div class="card-body pt-5">
                            ...
                            <form class="form" action="{{ route('contact.added') }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                <!--begin::Row-->
                            ...
                            <form class="form" action="{{ route('contacts.added') }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                <div id="formFields">
