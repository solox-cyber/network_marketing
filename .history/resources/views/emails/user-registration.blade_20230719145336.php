...
<body>
    ...
    <p>Dear {{ $user->name }},</p>
    <p>Welcome to Lern.Africa, where your tech dreams come to life! We're thrilled to have you on board, and we want to ensure you make the most of your reserved seat.seat number is:
    </p>
