...
<body>
    ...
    <p>Dear {{ $user->name }},</p>
    <p>Welcome to Lern.Africa, where your tech dreams come to life! We're thrilled to have you on board, and we want to ensure you make the most of your reserved seat.
    </p>
    <p>To secure your spot, follow these simple steps:</p>
    <p>Kindly make Payment and log in to your account by clicking the link below:
        <a href="{{ $registrationLink }}">Register Now</a></p>
    ...
    <p>Earn referral commission by uploading your contact list of friends and family who are passionate about a career in tech. We'll handle the rest and ensure they receive the information they need to join this exciting journey.</p>
