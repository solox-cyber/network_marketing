            ...
            <div class="container">
                <div class="row justify-content-center">
                    <div class="page-title style1 col-xl-6 col-lg-6 col-md-10 text-center mb-5">
                        ...
                        <li class="active list-inline-item"><a class="fw-700 ls-3 font-xssss text-black text-uppercase ml-3 active" href="#navtabs1" data-toggle="tab">{{$course->course_cat}}</a></li>  
                      @endforeach
                        </ul>
