            ...
            @endif
                            ...
                            <!--begin::Input group-->
                                ...
                                <div class="row row-cols-1 row-cols-sm-2 rol-cols-md-1 row-cols-lg-2">
                                    ...
                                    <div class="col">
                                        ...
                                        <div class="fv-row mb-7">
                                            ...
                                            <!--begin::Input-->
                                            <input type="email" class="form-control form-control-solid" name="email" value="{{ Auth::user()->email }}" />
                                            <!--end::Input-->
                                        </div>
                                        <!--end::Input group-->
                                    ...
                                    <div class="col">
                                        ...
                                        <div class="fv-row mb-7">
                                            ...
                                            <!--begin::Input-->
                                            <input type="text" class="form-control form-control-solid" name="phone_number" value="{{ Auth::user()->phone_number }}" />
                                            <!--end::Input-->
                                        </div>
                                        <!--end::Input group-->
                                    </div>
                                ...
                                <div class="row row-cols-1 row-cols-sm-2 rol-cols-md-1 row-cols-lg-2">
                                    ...
                                    <div class="col">
                                        ...
                                        <div class="fv-row mb-7">
                                            ...
                                            <!--begin::Input-->
                                            <input type="text" class="form-control form-control-solid" name="city" value="{{ Auth::user()->city }}"/>
                                            <!--end::Input-->
                                        </div>
                                        <!--end::Input group-->
                                    </div>
                                ...
                                <div class="fv-row mb-7">
                                    ...
                                    <!--begin::Input-->
                                    <textarea class="form-control form-control-solid" name="notes">value="{{ Auth::user()->phone_number }}"</textarea>
                                    <!--end::Input-->
                                </div>
                                <!--end::Input group-->
