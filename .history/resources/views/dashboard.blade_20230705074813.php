        ...
        <span class="step-label">Certificate</span>
                                ...
                                <div class="text-center">
                                    ...
                                    <div class="container">
                                        ...
                                        {{$course->course_name}} {{$course->$course_tuition}}
                                        @endforeach
                                    </div>
                                </div>
                                @else
                                ...
                                <script>
                                    ...
                                    paymentButton.addEventListener('click', () => {
                                        ...
                                        const handler = PaystackPop.setup({
                                            ...
                                            number_format($course->tuition_fee, 2, '.', '') . '00'
                                            amount: '{{ number_format($course->tuition_fee, 2, '.', '') . '00'}}', // Replace with the actual payment amount
