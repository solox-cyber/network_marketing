...
<script>
                       function addFormField() {
                           ...
                           var newField = $('<form class="form" action="{{ route('
                               contact.add ') }}" method="POST" enctype="multipart/form-data">@csrf<div class="row row-cols-1 row-cols-sm-2 rol-cols-md-1 row-cols-lg-3">');
                           newField.html(
                               '<div class="col">' +
                               '<div class="fv-row mb-7">' +
                               '<label class="fs-6 fw-semibold form-label mt-3">' +
