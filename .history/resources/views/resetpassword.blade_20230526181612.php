                        ...
                        <div class="row mb-1">
                            <div class="col-lg-4">
                                <div class="fv-row mb-0">
                                    ...
                                    <input type="email" value="{{ $email ?? old('email') }}" class="form-control @error('email') is-invalid @enderror form-control form-control-lg form-control-solid " name="currentpassword" id="currentpassword" />
                    <!--end::Email-->
                    @error('email')
