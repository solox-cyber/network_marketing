...
@include('setting_methods.admin.salesmenuhead')
@include('setting_methods.admin.salesnavitems')
        ...
        <div class="card-body p-9">
            ...
            <div class="row mb-7">
                ...
                <div class="col-lg-8 d-flex align-items-center">
                    ...
                    <span class="badge badge-success text-white"><a href="tel:{{ $contact->phone }}" class="color:#fff!important;text-decoration:none">Call Contact</a></span>
                </div>
                <!--end::Col-->
            </div>
            <!--end::Input group-->
