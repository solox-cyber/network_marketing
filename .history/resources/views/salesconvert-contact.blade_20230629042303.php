                 ...
                 <div class="row mb-6">
                    ...
                    <div class="col-lg-8">
                        ...
                        <div class="row">
                            <!--begin::Col-->
                            <div class="col-lg-8 fv-row">
                                <input type="text" name="id" class="form-control form-control-lg form-control-solid mb-3 mb-lg-0" placeholder="Email Address" value="{{$contact->id}}" />
                                <input type="text" name="salesrep" class="form-control form-control-lg form-control-solid mb-3 mb-lg-0" placeholder="Email Address" value="{{Auth::id()}}" />
                            </div>
                            <!--end::Col-->
