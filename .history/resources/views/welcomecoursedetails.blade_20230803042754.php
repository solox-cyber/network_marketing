                ...
                <div class="row">
                    <div class="col-xl-8 col-xxl-9 col-lg-8">
                        ...
                        <div class="card d-block border-0 rounded-lg overflow-hidden dark-bg-transparent bg-transparent mt-4 pb-3">
                            ...
                            <span class="font-xssss fw-700 text-grey-900 d-inline-block ml-0 text-dark">{{$course->course_name}}</span>
                            <span class="dot ml-2 mr-2 d-inline-block btn-round-xss bg-grey"></span>

                            <span class="font-xssss fw-600 text-grey-500 d-inline-block ml-1">{{$course->course_tags}}</span>
