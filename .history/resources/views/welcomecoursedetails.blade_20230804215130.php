                ...
                <div class="row">
                    <div class="col-xl-8 col-xxl-9 col-lg-8">
                        ...
                        @if ($course->bannerPicture)
                                        <img src="{{ asset('storage/' . str_replace('public/', '', $courses->bannerPicture->path)) }}" height="50" width="50" alt="Course Logo">
                                        @endif
                    ...
                    <div class="col-xl-4 col-xxl-3 col-lg-4">
                        <div class="card p-4 mb-4 bg-primary border-0 shadow-xss rounded-lg">
                            <div class="card-body">
                                ...
                                <h5 class="display1-size text-white fw-700">₦{{ number_format($course->tuition_fee, 2) }}</h5>
                    ...
                    <div class="col-sm-12">
                        <div class="row">
                            <div class="col-md-12 col-lg-4 col-sm-9 col-xs-12 md-mb-2">
                                <a href="{{route('welcome')}}"> <img alt="Logo" src="{{asset('media/logos/lern-logo.png')}}" style="height:40px;width:60px;" class="img-fluid h-20px app-sidebar-logo-default" /></a>
                                <p class="w-100 mt-5">41 madison ave, floor 24 new work, <br>NY 10010 1-877-932-7111 <br> support@lern.africa</p>
                            ...
                            <div class="col-md-5 col-lg-2 col-sm-4 col-xs-6">
                                <h5>Links</h5>
                                <ul>
                                    <li><a href="#">Home</a></li>
