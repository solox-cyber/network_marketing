                ...
                <div class="row g-5 g-xl-10 mb-5 mb-xl-10">
                    ...
                    <div class="col-md-6 col-lg-6 col-xl-6 col-xxl-3 mb-md-5 mb-xl-10">
                        ...
                        <div class="card card-flush h-lg-50">
                            ...
                            <div class="card-header pt-5">
                                <!--begin::Title-->
                                <h3 class="card-title text-gray-800">Course Start Date: {{ date('jS \of F, Y', strtotime($courseStartDate)) }}
                                </h3>
                                <!--end::Title-->
    ...
    <div class="step">
        ...
        <span class="step-label">Certificate</span>
                                ...
                                <script>
                                    ...
                                    var courseDate = new Date("{{ $courseStartDate }}");

                                    // Calculate the time remaining until the course date
                                    var countdownDate = courseDate.getTime() - new Date().getTime();
                    ...
                    <div class="col-xxl-6">
                        ...
                        <div class="card card-flush h-md-100">
                            ...
                            <div class="card-header pt-5">
                                ...
                                <h5 class="card-title align-items-start flex-column">My Courses</h5>
                                <!--end::Title-->
