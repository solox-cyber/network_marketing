...
<div class="card mb-5 mb-xl-10">
    ...
    <div class="card-header border-0 cursor-pointer" role="button" data-bs-toggle="collapse" data-bs-target="#kt_account_profile_details" aria-expanded="true" aria-controls="kt_account_profile_details">
        <!--begin::Card title-->
        <div class="card-title m-0 mr-3">
            <h3 class="fw-bold m-0 ">Pay Out Details</h3>
             <!--begin::Badge-->
       <span class="badge badge-light-success fs-base m">
                                            <i class="ki-duotone ki-arrow-up fs-2 text-success ms-n1"><span class="path1"></span><span class="path2"></span></i>
                                            Current Balance
                                        </span>
                                        <!--end::Badge-->
        </div>
