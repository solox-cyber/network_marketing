                                ...
                                <div class="row">
                                    <div class="col-lg-6 col-md-12">
                                        <div class="form-group mb-3">
                                            <input type="text" name="name" class="form-control style2-input bg-color-none text-grey-700" value="Name">
                                        </div>
                                    </div>
                                    <div class="col-lg-6 col-md-12">
                                        <div class="form-group mb-3">
                                            <input type="text" name="email" class="form-control style2-input bg-color-none text-grey-700" value="Email">
                                        </div>
                                    </div>

                                    <div class="col-12">
                                        <div class="form-group mb-3 md-mb-2">
                                            <textarea name="message" class="w-100 h125 style2-textarea p-3 form-control">Message</textarea>
                                        </div>
                                        ...
                                        <div class="form-group"><a href="#" class="rounded-lg style1-input float-right bg-current text-white text-center font-xss fw-500 border-2 border-0 p-0 w175">Submit</a></div>
                                    </div>
                                </div>
