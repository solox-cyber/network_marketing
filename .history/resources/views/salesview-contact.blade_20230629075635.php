...
<div class="card mb-5 mb-xl-10" id="kt_profile_details_view">
    ...
    <div class="card-header cursor-pointer">
        ...
        <!--end::Card title-->
        <div class="card-title m-0">
        <a href="{{ route('salescontact.convert', ['id' => $contact->id]) }}" class="btn btn-sm btn-primary ms-auto">Convert Contact</a>
        </div>
    </div>
    <!--begin::Card header-->
...
<div class="row mb-7">
    ...
    <div class="col-lg-8 d-flex align-items-center">
        ...
        <span class="badge badge-success">
            <a href="tel:{{ $contact->phone }}" style="color: white; text-decoration: none;">Call Contact</a>
        </span>
    </div>
    <!--end::Col-->
</div>
