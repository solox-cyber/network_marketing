...
<div class="app-main flex-column flex-row-fluid" id="kt_app_main">
    ...
    <div class="image-input-wrapper w-100px h-100px" style="background-image: url({{ asset('storage/' . str_replace('public/', '', $contact->profilePicture->path)) }})"></div>

@else
<div class="image-input-wrapper w-100px h-100px" style="background-image: url({{ substr($contact->name, 0, 1) }})"></div>
                    ...
                    @endif
                                            ...
                                            <label class="btn btn-icon btn-circle btn-active-color-primary w-25px h-25px bg-body shadow" data-kt-image-input-action="change" data-bs-toggle="tooltip" title="Change avatar">
                                                ...
                                                <!--begin::Inputs-->
                                                <div class="image-input-wrapper w-100px h-100px" style="background-image: url({{ Auth::user()->profilePicture ? asset('storage/' . str_replace('public/', '', Auth::user()->profilePicture->path)) : asset('storage/default-profile-picture.jpg') }})"></div>
