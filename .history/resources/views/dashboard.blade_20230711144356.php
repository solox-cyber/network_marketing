                            ...
                            <div class="card-body d-flex align-items-end pt-0">
                                ...
                                <div class="d-flex align-items-center flex-column mt-3 w-100">
                                    ...
                                    <div class="h-8px mx-3 w-100 bg-white bg-opacity-50 rounded">
                                        <div class="bg-white rounded h-8px" role="progressbar" style="width: {{ $level }};" aria-valuenow="{{$level}}" aria-valuemin="0" aria-valuemax="100"></div>
                                    </div>
                                </div>
                                <!--end::Progress-->
                            </div>
    ...
    <div class="step">
        ...
        <span class="step-label">Certificate</span>
                                ...
                                <div class="text-center">
                                    ...
                                    <div class="container">
                                        <h1 style="color:red">Payment Status: Paid</h1>
                                ...
                                <script>
                                    ...
                                    paymentButton.addEventListener('click', () => {
                                        ...
                                        const handler = PaystackPop.setup({
                                            ...
                                            amount: '{{$feeAmount}}', // Replace with the actual payment amount
                                            ...
                                            <table class="table table-row-dashed align-middle gs-0 gy-3 my-0">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <p>{!! Str::limit($course->about_course, 500) !!} <br><a href="{{ route('course.details', ['id' => $course->id]) }}" class="btn btn-primary btn-sm">Read More</a></p>
                                                    </tr>
...
<div class="container">
  <div class="row justify-content-center">
    <div class="col step {{$enrollment_status == 1 ? 'active' : ''}}">
      <div class="step-number">1</div>
      <div class="step-label">Registration</div>
    </div>
    <div class="col step {{$enrollment_status == 2 ? 'active' : ''}}">
      <div class="step-number">2</div>
      <div class="step-label">Payment</div>
    </div>
    <div class="col step {{$enrollment_status == 3 ? 'active' : ''}}">
      <div class="step-number">3</div>
      <div class="step-label">Progress</div>
    </div>
    <div class="col step {{$enrollment_status == 4 ? 'active' : ''}}">
