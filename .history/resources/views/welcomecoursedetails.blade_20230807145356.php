                    ...
                    <div class="col-xl-4 col-xxl-3 col-lg-4">
                        <div class="card p-4 mb-4 bg-primary border-0 shadow-xss rounded-lg">
                            <div class="card-body">
                                ...
                                <a href="{{route('enroll', ['course_id' => $course->course_name])}}" class="btn btn-block border-0 w-100 bg-white p-3 text-primary fw-600 rounded-lg d-inline-block font-xssss btn-light">Enroll</a>
