...
<div class="app-main flex-column flex-row-fluid" id="kt_app_main">
    ...
    <div class="d-flex flex-column flex-column-fluid">
        ...
        <div id="kt_app_content" class="app-content  flex-column-fluid ">
            ...
            <select name="status" data-control="select2" data-hide-search="true" class="form-select form-select-sm bg-body border-body fw-bold w-125px" onchange="this.form.submit()">
...
<div class="col-md-6 col-xl-4">
    ...
    <span class="card border-hover-primary">
        ...
        <div class="card-header border-0 pt-9">
            ...
            <div class="card-title m-0">
                ...
                <td>
                    ...
                    <img src="{{ asset('storage/' . str_replace('public/', '', $course->profilePicture->path)) }}" alt="image" class="p-3" alt="Course Logo">
                @endif
        ...
        <div class="card-body p-9">
            ...
            {{ Str::limit($course->about_course, 100, '...') }}
            </p>
            <!--end::Description-->
            ...
            <div class="d-flex flex-wrap mb-5">
                ...
                <div class="border border-gray-300 border-dashed rounded min-w-125px py-3 px-4 me-7 mb-3">
                    <div class="fs-6 text-gray-800 fw-bold">{{$course->instructor_name}}</div>
                    <div class="fw-semibold text-gray-400">Instructor Name</div>
                </div>
                <!--end::Due-->

                <!--begin::Budget-->
                <div class="border border-gray-300 border-dashed rounded min-w-125px py-3 px-4 mb-3">
                    <div class="fs-6 text-gray-800 fw-bold">₦ {{ number_format($course->tuition_fee, 2, '.', ',') }}
</div>
                    <div class="fw-semibold text-gray-400">Tuition Fee</div>
                </div>
                <!--end::Budget-->
            </div>
            <!--end::Info-->
