                        ...
                        <div class="card card-flush bgi-no-repeat bgi-size-contain bgi-position-x-end h-md-50 mb-5 mb-xl-10" style="background-color: #3E97FF;background-image:url('assets/media/svg/shapes/widget-bg-1.png')">
                            ...
                            <div class="card-header pt-5">
                                ...
                                <div class="card-title d-flex flex-column">
                                    <!--begin::Amount-->
                                    <span class="fs-2hx fw-bold text-white me-2 lh-1 ls-n2">{{ $contactCount }}</span>
                                    <!--end::Amount-->
                                    ...
                                    <!--end::Subtitle-->
                                    <!--begin::Amount-->
                                    <span class="fs-2hx fw-bold text-white me-2 lh-1 ls-n2">{{ $userCount  }}</span>
                                    <!--end::Amount-->
                            ...
                            <div class="card-body pt-2 pb-4 d-flex flex-wrap align-items-center">
                                ...
                                <div class="d-flex flex-column content-justify-center flex-row-fluid">
                                    ...
                                    <div class="d-flex fw-semibold align-items-center">
                                        ...
                                        <!--begin::Label-->
                                        <div class="text-gray-500 flex-grow-1 me-4">Total Number of Contacts</div>
                                        <!--end::Label-->
                                    ...
                                    <div class="d-flex fw-semibold align-items-center my-3">
                                        ...
                                        <!--begin::Label-->
                                        <div class="text-gray-500 flex-grow-1 me-4">Total Number of Users </div>
                                        <!--end::Label-->
                                    ...
                                    <div class="d-flex fw-semibold align-items-center">
                                        ...
                                        <!--begin::Label-->
                                        <div class="text-gray-500 flex-grow-1 me-4">Total Number of Down</div>
                                        <!--end::Label-->
