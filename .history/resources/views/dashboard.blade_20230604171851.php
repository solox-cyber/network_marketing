                            ...
                            <div class="card-body d-flex align-items-end pt-0">
                                ...
                                <div class="d-flex align-items-center flex-column mt-3 w-100">
                                    ...
                                    <div class="h-8px mx-3 w-100 bg-white bg-opacity-50 rounded">
                                        <div class="bg-white rounded h-8px" role="progressbar" style="width: {{ $SerialNumber }};" aria-valuenow="50" aria-valuemin="0" aria-valuemax="100"></div>
                                    </div>
                                </div>
                                <!--end::Progress-->
                            </div>
...
<div class="stepper stepper-pills" id="kt_stepper_example_basic">
    ...
    <div class="stepper-nav flex-center flex-wrap mb-10">
        ...
        <!--end::Step 3 - Certificate-->
    </div>
    <!--end::Nav-->

    <!--begin::Form-->
    <form class="form w-lg-500px mx-auto" novalidate="novalidate" id="kt_stepper_example_basic.
