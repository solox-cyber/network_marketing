    ...
    <div class="step">
        ...
        <span class="step-label">Certificate</span>
                    ...
                    <div class="col-xxl-6">
                        ...
                        <div class="nav-icon mb-6">
                        @if ($profile_picture)
                    <img src="{{ asset('storage/' . str_replace('public/', '', $profile_picture->path)) }}" alt="image" class="p-3" alt="Course Logo" style="height:70px!important;width:70px!important">
                @endif
                                            </div>
