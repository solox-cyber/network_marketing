...
<div class="d-flex flex-column flex-center flex-column-fluid">    
    ...
    <!--begin::Illustration-->
    <div class="mb-3">
        <img src="../../assetsmedia/auth/404.png" class="mw-100 mh-300px theme-light-show" alt=""/>
        <img src="../../assetmedia/auth/404-dark.png" class="mw-100 mh-300px theme-dark-show" alt=""/>
    </div>
    <!--end::Illustration-->
