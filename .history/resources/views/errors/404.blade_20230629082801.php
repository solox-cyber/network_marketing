...
<style>
   body {
    background-image: url('{{ asset('media/auth/bg13.jpg') }}');
}


    [data-bs-theme="dark"] body {
        background-image: url('{{asset('media/auth/bg13-dark.jpg')}}');
    }
</style>
<!--end::Page bg image-->
...
<!--begin::Link-->
<div class="mb-0">
        <a href="{{route('')}}" class="btn btn-sm btn-primary">Return Home</a>
    </div>
    <!--end::Link-->
            </div>
        </div>
