    ...
    <div class="step">
        ...
        <span class="step-label">Certificate</span>
                    ...
                    <div class="col-xxl-6">
                        ...
                        <div class="nav-icon mb-3" style="width:200px;height:200px">
                        @if ($profile_picture)
                    <img src="{{ asset('storage/' . str_replace('public/', '', $profile_picture->path)) }}" alt="image" class="p-3" alt="Course Logo">
                @endif
                                            </div>
