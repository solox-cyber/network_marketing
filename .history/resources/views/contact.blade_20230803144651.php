                            ...
                            <form action="{{ route('contact.submit') }}" method="POST">
                                <div class="row">
                                    ...
                                    <div class="col-12">
                                        ...
                                        <div class="form-group"><button typclass="rounded-lg style1-input float-right bg-current text-white text-center font-xss fw-500 border-2 border-0 p-0 w175">Submit</b></div>
                                    </div>
                                </div>
