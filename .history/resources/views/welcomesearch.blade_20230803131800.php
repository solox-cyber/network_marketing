...
<!-- Mirrored from uitheme.net/elomoas/default-search.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 02 Aug 2023 22:54:07 GMT -->
<head>
    <meta charset="UTF-8">
            ...
            <div class="container pl-0 pr-0">
                <div class="nav-content">
                    ...
                    <ul class="mb-3">
                        ...
                        <li><a href="default.html" class="nav-content-bttn open-font" data-tab="chats"><i class="feather-tv mr-3"></i><span>Course Feed</span></a></li>
        ...
        <div class="main-content">
            <div class="middle-sidebar-header bg-white">
                ...
                <ul class="d-flex ml-auto right-menu-icon">
                    ...
                    <li><a href="default-user-profile.html"><img src="images/female-profile.png" alt="user" class="w40 mt--1"></a></li>
                ...
                <div class="middle-sidebar-left">
                    <div class="row">
                                        ...
                                        <div class="row">
                                            <div class="col-lg-5">
                                                <div class="form-group icon-input mb-0">
                                                    ...
                                                    <input type="text" class="style1-input border-0 pl-5 font-xsss mb-0 text-grey-500 fw-500 bg-transparent" placeholder="Search online courses..">
                                                </div>
                                            </div>
                        ...
                        <div class="col-lg-12 pt-2 mb-4">
                            <h2 class="fw-400 font-lg">Search <b>Results</b> <span class="fw-500 ml-2 text-grey-500 font-xssss">( 23 course is found )</span> <a href="#" class="float-right" ><i class="feather-edit text-grey-500 font-xs"></i></a></h2>
                        </div>
                       ...
                       <div class="col-xl-4 col-xxxl-3 col-lg-6 col-md-6 col-sm-6 mb-4">
                        ...
                        <div class="col-xl-4 col-xxxl-3 col-lg-6 col-md-6 col-sm-6 mb-4">
                            <div class="card w-100 p-0 shadow-xss border-0 rounded-lg overflow-hidden mr-1 course-card">
                                <div class="card-image w-100 mb-3">
                                    <a href="default-course-details.html" class="video-bttn position-relative d-block"><img src="images/v-7.jpg" alt="image" class="w-100"></a>
                                </div>
                                <div class="card-body pt-0">
                        ...
                        <div class="col-xl-4 col-xxxl-3 col-lg-6 col-md-6 col-sm-6 mb-4">
                            <div class="card w-100 p-0 shadow-xss border-0 rounded-lg overflow-hidden mr-1 course-card">
                                <div class="card-image w-100 mb-3">
                                    <a href="default-course-details.html" class="video-bttn position-relative d-block"><img src="images/v-8.jpg" alt="image" class="w-100"></a>
                                </div>
                                <div class="card-body pt-0">
                                    <span class="font-xsssss fw-700 pl-3 pr-3 lh-32 text-uppercase rounded-lg ls-2 alert-danger d-inline-block text-danger mr-1">Develop</span>
                                    <span class="font-xss fw-700 pl-3 pr-3 ls-2 lh-32 d-inline-block text-success float-right"><span class="font-xsssss">$</span> 370</span>
...
<!-- Mirrored from uitheme.net/elomoas/default-search.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 02 Aug 2023 22:54:09 GMT -->
</html>
