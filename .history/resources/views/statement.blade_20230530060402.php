                        ...
                        <div class="card  card-xxl-stretch mb-5 mb-xxl-10">
                            ...
                            <div class="card-body pb-0">
                                ...
                                <div class="d-flex flex-wrap justify-content-between pb-6">
                                    ...
                                    <a href="{{route('payout')}}" class="btn btn-primary  px-6 flex-shrink-0 align-self-center">Withdraw Earnings</a>
                                </div>
                                <!--end::Left Section-->
                            </div>
                            <!--end::Body-->
                                ...
                                <table class="table align-middle table-row-bordered table-row-solid gy-4 gs-9">
                                    ...
                                    <tbody class="fs-6 fw-semibold text-gray-600">
                                        ...
                                        <tr>
                                            ...
                                            @if($statement->type === 'pending')
                                            <td class="text-danger">{{ $statement->type }}</td>
                                            @else
                                            @endif
