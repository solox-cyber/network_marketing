                ...
                <div class="row justify-content-center">
                    <div class="page-title style1 col-xl-6 col-lg-6 col-md-10 text-center mb-5">
                        ...
                        <ul class="nav nav-tabs tabs-icon list-inline d-block w-100 text-center border-bottom-0 mt-4" id="myNavTabs">
                            @foreach ($courses as $course)
                            <li class="active list-inline-item"><a class="fw-700 ls-3 font-xssss text-black text-uppercase ml-3 active" href="#{{ str_replace(' ', '', $course->course_cat) }}
" data-toggle="tab">{{$course->course_cat}}</a></li>
                            @endforeach
                        </ul>
