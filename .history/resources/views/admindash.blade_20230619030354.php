        ...
        <ul class="nav nav-pills nav-pills-custom mb-3 mx-9">
                ...
                <li class="nav-item mb-3 me-3 me-lg-6">
                    ...
                    <a class="nav-link btn btn-outline btn-flex btn-active-color-primary flex-column overflow-hidden w-80px h-85px pt-5 pb-2
                        ...
                        <!--begin::Icon-->
                        <div class="nav-icon mb-3">
                            <i class="ki-duotone ki-user-squre fs-1 p-0"><span class="path1"></span><span class="path2"></span><span class="path3"></span><span class="path4"></span><span class="path5"></span></i>
                        </div>
                        <!--end::Icon-->
