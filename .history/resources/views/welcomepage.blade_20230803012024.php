                ...
                <div class="row">
                    <div class="col-xxxl-7 col-xl-7 vh-md-100 pt-7 pb-7 align-items-center d-flex">
                        <div class="card w-100 border-0 bg-transparent">
                            <h2 class="fw-700 text-grey-900 display5-size display4-xs-size lh-1 mb-0 aos-init" data-aos="fade-up" data-aos-delay="200" data-aos-duration="500">Join  <br><span class="text-current">Lern.Africa</span> for affordable top-notch Tech Courses<i class="feather-slack text-success font-xxl"></i></h2>
