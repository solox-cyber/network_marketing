    ...
    <div class="d-flex flex-center flex-column flex-lg-row-fluid">
        ...
        <div class="w-lg-500px p-10">
            ...
            <div id="registrationForm">
                ...
                <div class="fv-row mb-8">
                    <!--begin::Phone Number-->
                    <input id="upline" type="text" placeholder="upline" name="upline" value="{{ $formFields['upline'] }}" autocomplete="phone_number" class="form-control @error('phone_number') is-invalid @enderror bg-transparent" required />
                    <!--end::Phone Number-->
                    @error('phone_number')
                    <span class="invalid-feedback" role="alert">
                        <strong>{{ $message }}</strong>
