          ...
          <!-- <form class="form w-100" action="{{ route('register') }}" method="POST">
                ...
                <script>
                    ...
                    paymentButton.addEventListener('click', () => {
                        ...
                        const phone_number = document.querySelector('select[name="phone_number"]').value;
                        const password = document.querySelector('select[name="password"]').value;
