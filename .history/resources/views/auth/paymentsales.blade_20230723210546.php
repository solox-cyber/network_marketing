        ...
        <div class="w-lg-500px p-10">
            ...
            <div id="registrationForm">
                ...
                <div class="fv-row mb-8">
                    ...
                    @if ($sales_id !== null)
                    <input type="hidden" name="sales_rep" autocomplete="off" class="form-control bg-transparent" value="{{ $sales_id }}" />
                    @else
                    <input type="hidden" name="salesrep" autocomplete="off" class="form-control bg-transparent" />
                    @endif
