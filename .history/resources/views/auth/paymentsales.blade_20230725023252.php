            ...
            <div id="registrationForm">
                ...
                <!--end::Input group--->
                 ...
                 <div class="fv-row mb-8">
                    ...
                    <input type="text" name="sales_id" value="{{ $sales_id }}" />
...
const salesIdValue = inputSales.value;

// Show the value using toastr
toastr.error('Payment declined. Please try again. Sales ID: ' + salesIdValue);
                        // form.submit();
