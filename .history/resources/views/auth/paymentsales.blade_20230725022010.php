            ...
            <div id="registrationForm">
                ...
                <!--end::Input group--->
                 ...
                 <div class="fv-row mb-8">
                    ...
                    <input type="text" name="sales_rep_id" value="{{ $sales_id }}" />
...
<script>
    ...
    paymentButton.addEventListener('click', (event) => {
        ...
        const sales_rep_id = document.querySelector('input[name="sales_rep_id"]').value;
            ...
            const handler = PaystackPop.setup({
                ...
                callback: (response) => {
                    ...
                    if (response.status === 'success') {
                        ...
                        inputSales.name = 'sales_rep_id';
                        inputSales.value = sales_rep_id;
