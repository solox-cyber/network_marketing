...
<script>
    ...
    const pusher = new Pusher('{{ env('PUSHER_APP_KEY') }}', {
        ...
        encrypted: true, // Set to true if your app uses HTTPS
    });

    // Subscribe to the public channel for new user notifications
    const channel = pusher.subscribe('public-new-user-registered');

    // Bind to the event
    channel.bind('App\\Events\\NewUserRegisteredEvent', function(data) {
        // Show the notification popup or perform any other action
        alert(data.message);
    });
</script>
