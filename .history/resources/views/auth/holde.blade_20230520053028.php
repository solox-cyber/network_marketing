...
<div class="d-flex flex-column flex-center flex-column-fluid">
    ...
    <div class="fs-6 mb-8">
        ...
        <a href="{{ route('register') }}" class="link-primary fw-bold"> Try Again</a>
    </div>
    <!--end::Action-->

    <!--begin::Link-->
    <div class="mb-11">
        <a href="{{ route('login') }}" class="btn btn-sm btn-primary">Skip for now</a>
    </div>
    <!--end::Link-->
    ...
    <div class="mb-0">
        ...
        <img src="../../assetmedia/auth/verify-email-dark.png" class="mw-100 mh-300px theme-dark-show" alt=""/>
    </div>
    <!--end::Illustration-->
