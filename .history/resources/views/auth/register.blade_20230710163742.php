    ...
    <div class="d-flex flex-center flex-column flex-lg-row-fluid">
        ...
        <div class="w-lg-500px p-10">
            ...
            <form class="form w-100" action="{{ route('register') }}" method="POST">
                ...
                @php
    $selectedCourseId = request('service'); // Assuming 'service' is the name attribute of the select field
    $tuitionFee = 0;

    if ($selectedCourseId && isset($courses[$selectedCourseId])) {
        $tuitionFee = $courses[$selectedCourseId]->tuition_fee;
    }
@endphp
