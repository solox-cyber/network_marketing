    ...
    <div class="d-flex flex-center flex-column flex-lg-row-fluid">
        ...
        <div class="w-lg-500px p-10">
            ...
            <form class="form w-100" action="{{ route('register') }}" method="POST">
                ...
                <div class="fv-row mb-8">
                    <select name="service" aria-label="Select a Service" data-control="select2" data-placeholder="Select a service..." class="form-select form-select-solid form-select-lg fw-semibold">
<option> </option>
