    ...
    <div class="d-flex flex-center flex-column flex-lg-row-fluid">
        ...
        <div class="w-lg-500px p-10">
            ...
            <div id="registrationForm">
                ...
                <div class="fv-row mb-8">
                    <!--begin::Phone Number-->
                    <input id="upline" type="hidden" placeholder="upline" name="upline" value="{{ $formFields['upline'] }}" autocomplete="upline" class="form-control @error('upline') is-invalid @enderror bg-transparent" required />
                    <!--end::Phone Number-->
                    @error('upline')
                    <span class="invalid-feedback" role="alert">
                        <strong>{{ $message }}</strong>
            ...
            const handler = PaystackPop.setup({
                ...
                callback: (response) => {
                    ...
                    if (response.status === 'success') {
                        ...
                        const upline = document.createElement('input');
                        inputSales.type = 'hidden';
                        inputSales.name = 'upline';
                        inputSales.value = uplineupline;
                        form.appendChild(inputSales);
