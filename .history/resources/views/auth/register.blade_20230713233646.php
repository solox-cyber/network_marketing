...
<div class="d-flex flex-column flex-lg-row-fluid w-lg-50 p-10">
  ...
  paymentButton.addEventListener('click', (event) => {
    ...
    if (validateForm(name, email, service, phone_number, password, password_confirmation)) {
      ...
      const handler = PaystackPop.setup({
        ...
        callback: (response) => {
          ...
          if (response.status === 'success') {
            ...
            submitFormData(name, email, service, phone_number, password, password_confirmation);
      ...
      // Add custom cancel button to the Paystack popup
      handler.addCustomField({
        display_name: 'Cancel',
        variable_name: 'cancel',
        value: 'true',
      });
  ...
  function submitFormData(name, email, service, phone_number, password, password_confirmation) {
