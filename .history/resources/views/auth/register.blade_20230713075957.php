...
<div class="d-flex flex-column flex-lg-row-fluid w-lg-50 p-10">
    ...
    <div class="d-flex flex-center flex-column flex-lg-row-fluid">
                ...
                <script>
                    ...
                    paymentButton.addEventListener('click', (event) => {
                        ...
                        if (validateForm(name, email, service, phone_number, password, password_confirmation)) {
                            ...
                            saveUserData(name, email, service, phone_number, password);
                    ...
                    function saveUserData(name, email, service, phone_number, password) {
      // Make an AJAX request to save the user data into another table
      // Replace the URL with the appropriate endpoint for saving user data
      ...
      // Make the AJAX request using the Fetch API or other AJAX libraries
      fetch(url, {
        method: 'POST',
        headers: {
  ...
  if (response.ok) {
    ...
    response.json().then(data => {
      if (data && data.error) {
        alert('Failed to save user data. Error: ' + data.error);
      } else {
