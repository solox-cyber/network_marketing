...
<div class="d-flex flex-column flex-lg-row-fluid w-lg-50 p-10">
    ...
    paymentButton.addEventListener('click', (event) => {
        ...
        if (validateForm(name, email, service, phone_number, password, password_confirmation)) {
            ...
            saveUserData(name, email, service, phone_number, password, password_confirmation)
                .then(response => {
                    if (response.ok) {
    ...
    function saveUserData(name, email, service, phone_number, password, password_confirmation) {
