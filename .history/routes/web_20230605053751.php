...
Route::middleware(['auth', 'admin'])->prefix('admin')->group(function () {
    ...
    Route::get('/setting', [AdminDashboardController::class, 'setting'])->nae('admin.setting');
    Route::get('/contact', [AdminDashboardController::class, 'contact'])->name('admin.contact');
    Route::get('/userlist', [AdminDashboardController::class, 'userlist'])->name('admin.userlist');
});
