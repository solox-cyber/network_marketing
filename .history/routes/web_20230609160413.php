...
Route::middleware(['auth', 'admin'])->prefix('admin')->group(function () {
    ...
    Route::get('/overview', [AdminDashboardController::class, 'profile'])->name('admin.overview');
    Route::get('/setting', [AdminDashboardController::class, 'setting'])->name('admin.setting');
    Route::get('/contact', [AdminDashboardController::class, 'contact'])->name('admin.contact');
    ...
    Route::get('/salesrep/add', [DashboardController::class, 'salesAdd'])->name('admin.salesrep');
Route::post('/salesreps', [DashboardController::class, 'salesStore'])->name('salesreps.store');
Route::get('/salesreps/view', [DashboardController::class, 'salesView'])->name('view.salesrep');
Route::get('/sales-reps/{id}', [DashboardController::class, 'sa;esShow'])->name('sales-reps.show');
