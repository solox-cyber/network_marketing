...
Route::middleware(['auth', 'verified'])->group(function () {
    ...
    Route::get('/reset-password', [DashboardController::class, 'resetcreate'])->name('password.reset');
Route::post('/reset-password', [DashboardController::class, 'resetstore'])->name('password.update');
});
