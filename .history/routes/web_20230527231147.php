...
Route::middleware(['auth', 'verified'])->group(function () {
    ...
    Route::get('/dashboard/password/reset', [DashboardController::class, 'passwordReset'])->name('pass.reset');
Route::post('/dashboard/password/reset{token}', [DashboardController::class, 'passwordStore'])->name('pass.update');
});
