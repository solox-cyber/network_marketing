...
Route::middleware(['auth', 'admin'])->prefix('admin')->group(function () {
    ...
    Route::post('/salesrep/commission/{id}/paid', [DashboardController::class, 'status_paid'])->name('salespaid');
    Route::post('/salesrep/commission/{id}/progress', [DashboardController::class, 'status_inprogress'])->name('salesprogress');
    Route::post('/salesrep/commission/{id}/decline', [DashboardController::class, 'status_decline'])->name('salesdecline');
