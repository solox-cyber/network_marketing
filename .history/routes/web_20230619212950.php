...
Route::middleware(['auth', 'admin'])->prefix('admin')->group(function () {
    ...
    Route::get('/coursez/{id}', [DashboardController::class, 'courseShow'])->name('course.view');
    Route::delete('contacts/{contact}', [DashboardController::class, 'ContactDestroy'])->name('course.destroy');
});
