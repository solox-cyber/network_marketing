...
// salesrep dashboard routes
    ...
    Route::post('/payout', [DashboardController::class, 'payoutGate'])->name('salespayment.payout');
    Route::get('/invitation/contacts', [DashboardController::class, 'inviteList'])->name('invites.index');
});
