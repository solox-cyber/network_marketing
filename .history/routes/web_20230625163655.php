...
Route::get('/salesrep/login', [DashboardController::class, 'adminDash'] 'SalesRepAuthController@showLoginForm')->name('salesrep.login');
Route::post('/salesrep/login', 'SalesRepAuthController@login')->name('salesrep.login.submit');
