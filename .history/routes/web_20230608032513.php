...
Route::middleware(['auth', 'admin'])->prefix('admin')->group(function () {
    ...
    Route::patch('/commission/{id}', [DashboardController::class, 'status_paid'])->name('walletstatement.paid');
    Route::patch('/commission/{id}', [DashboardController::class, 'status_inprogress'])->name('walletstatement.progress');
