...
Route::middleware(['auth', 'admin'])->prefix('sales')->group(function () {
    Route::get('/home', [DashboardController::class, 'adminDash'])->name('sales.dashboard');
    Route::get('/profile', [DashboardController::class, 'adminprofile'])->name('sales.profile');
    Route::get('/setting', [DashboardController::class, 'adminsetting'])->name('sales.setting');
}
