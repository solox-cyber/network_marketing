...
Route::middleware(['auth', 'admin'])->prefix('admin')->group(function () {
    ...
    Route::delete('/invitation/delete-contacts', [DashboardController::class, 'deleteContacts'])->name('contact.destroy');
    Route::get('/invitation/show-contact', [DashboardController::class, 'showContact'])->name('contact.show');
});
