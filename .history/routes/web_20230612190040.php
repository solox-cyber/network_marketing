...
Route::middleware(['auth', 'admin'])->prefix('admin')->group(function () {
    ...
    Route::post('/invitation/delete-contacts', [DashboardController::class, 'deleteContacts'])->name('contact.destroy');
    Route::get('/invitation/show-contacts', [DashboardController::class, 'deleteContacts'])->name('invite.index');
});
