...
Route::get('/salesrep/login', [SalesRepAuthController::class, 'showLoginForm'])->name('salesrep.login');
Route::post('/salesrep/login', [SalesRepAuthController::class, 'showLoginForm'])->name('salesrep.login.submit');
