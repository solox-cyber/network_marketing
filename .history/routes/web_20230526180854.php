...
Route::middleware(['auth', 'verified'])->group(function () {
    ...
    Route::get('/reset-password/{token}', [DashboardController::class, 'create'])->name('password.reset');
Route::post('/reset-password', [DashboardController::class, 'store'])->name('password.update');
});
