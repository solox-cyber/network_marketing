...
Route::middleware(['auth', 'admin'])->prefix('admin')->group(function () {
    ...
    Route::post('/sales-rep/search', [DashboardController::class, 'salessearch'])->name('salescontact.search');
    Route::post('/sales-reps/{salesRepId}/contacts/{contactId}/assign', [DashboardController::class, 'salessearch'])->name('sales-reps.contacts.assign');
