...
Route::prefix('salesrep')->group(function () {
    Route::get('log', [SalesRepController::class, 'showLoginForm'])->name('salesrep.login.form');
    Route::post('log', [SalesRepController::class, 'login']);
    Route::post('logout', [SalesRepController::class, 'logout'])->name('salesrep.logout');
    Route::get('dashboard', [SalesRepController::class, 'showDashboard'])->name('salesrep.dashboard');
