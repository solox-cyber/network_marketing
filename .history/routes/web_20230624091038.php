...
Route::prefix('salesrep')->group(function () {
    Route::get('login', [SalesRepController::class, 'showLoginForm'])->name('salesrep.login');
    Route::post('login', [SalesRepController::class, 'login']);
    Route::post('logout', [SalesRepController::class, 'logout'])->name('salesrep.logout');
    Route::get('dashboard', [SalesRepController::class, 'logout']'Auth\SalesRepController@showDashboard')->name('salesrep.dashboard');


    // Add other salesrep routes as needed
});
