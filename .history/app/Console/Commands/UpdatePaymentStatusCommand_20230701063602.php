...
class UpdatePaymentStatusCommand extends Command
{
    ...
    public function handle()
    {
        ...
        foreach ($users as $user) {
            ...
            $this->sendAccountExpiredEmail($user,$activationCode);
    ...
    private function sendAccountExpiredEmail(User $user, $activationCode)
    {
        ...
        // });
        Mail::to($user->email)->send(new AccountExpired($user, $activationCode));
