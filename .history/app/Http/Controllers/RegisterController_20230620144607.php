...
// Include the serial number in the verification email
$verificationUrl = $user->verificationUrl();

Mail::to($user->email)->send(function ($message) use ($user, $serialNumber, $verificationUrl) {
    $message->subject('Email Verification');
    $message->view('emails.verify', ['user' => $user, 'serialNumber' => $serialNumber, 'verificationUrl' => $verificationUrl]);
});
