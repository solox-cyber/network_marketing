    ...
    public function index()
    {
        ...
        if (Auth::id()) {
            ...
            if ($usertype == 'user') {
                ...
                $totalCountUser = User::where('usertype', 'user')
    ->where('id', '>', $user->id)
    ->count();
                ...
                return view('dashboard', compact('course_name', 'about_course', 'contactCount', 'course', 'userCount', 'totalCount', 'totalCountUsers', 'WalletAmount', 'commissionPercentage', 'level', 'service', 'serial_number'));
