    ...
    public function index()
    {
        ...
        if (Auth::id()) {
            ...
            if ($usertype == 'user') {
                ...
                //retrieve course start date related to user registration
                $course = $user->service;
                $courseStartDate = Course::where('id', $course)->value('start_date');
                ...
                return view('dashboard', compact('contactCount', 'courseStartDate', 'course', 'userCount', 'totalCount', 'WalletAmount', 'commissionPercentage', 'level', 'service', 'serial_number'));
