    ...
    public function commissions()
    {
        if (auth()->user()->usertype === 'admin' || auth()->user()->usertype === 'subadmin') {
            ...
            foreach ($walletStatements as $walletStatement) {
                ...
                $userWalletAmount = User::where('id', $walletStatement->user_id)->value('wallet_amount');
                $walletStatement->user->walletamount = $userWalletAmount;
            }
            return view('admin.commission-list', ['walletStatements' => $walletStatements], compact('WalletAmount', 'WalletAmountGross','userWalletAmount'));
        }
