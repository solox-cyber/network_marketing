...
class DashboardController extends Controller
{
    ...
    public function index()
    {
        ...
        if (Auth::id()) {
            ...
            if ($usertype == 'user') {
                ...
                return view('dashboard', compact('course_name', 'about_course', 'contactCount', 'course', 'userCount', 'totalCount', 'WalletAmount', 'commissionPercentage', 'level', 'service', 'serial_number'));
    ...
    public function commissions()
    {
        if (auth()->user()->usertype === 'admin') {
            ...
            $walletStatements = WalletStatement::with('user')->paginate(1);
    ...
    public function searchSales(Request $request)
    {
        ...
        $salesReps = SalesRep::where('name', 'like', "%$search%")->get();
        ...
        // Perform the search query for contacts of the found sales representatives
        $contacts = Contact::whereIn('sales_rep_id', $salesReps->pluck('id'))->get();

        return view('admin.salessearch-results', compact('salesReps', 'contacts'));
    }
    ...
    public function inviteList()
    {
        if (auth()->user()->usertype === 'admin') {
            ...
            // Get all contacts with the related user details
            $contacts = Contact::with('user', 'salesRep')->get();
