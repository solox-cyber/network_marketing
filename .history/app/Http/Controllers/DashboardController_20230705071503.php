    ...
    public function index()
    {
        ...
        if (Auth::id()) {
            ...
            if ($usertype == 'user') {
                ...
                $course_created_at = $user->created_at;
                ...
                return view('dashboard', compact('courseDetails', 'contactCount', 'course_created_at','userCount', 'totalCount', 'WalletAmount', 'commissionPercentage', 'level', 'service', 'serial_number'));
