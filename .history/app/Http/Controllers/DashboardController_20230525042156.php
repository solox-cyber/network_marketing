...
class DashboardController extends Controller
{
    ...
    public function index()
    {
      ...
      $user = Auth::user();
      $contactCount = Contact::whereDate('created_at', '>', $user->created_at)->count();
      $userCount = User::whereDate('created_at', '>', $user->created_at)->count();
      $totalCount = $contactCount +$userCount;

        return view('dashboard', compact('contactCount', 'userCount'));
    }
