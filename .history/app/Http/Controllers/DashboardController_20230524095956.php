...
class DashboardController extends Controller
{
    ...
    public function EditContact(Contact $contact)
    {
      ...
      $contact = Contact::find($contact->user_id);

        $contacts = $user->contacts;
        $count = $user->contacts()->count();
        return view('edit-contact', compact('contacts'), compact('contact'), compact('count'));
    }


    public function ShowContact($id){
        $contact = Contact::findOrFail($id);
    return view('contacts.show', compact('contact'),compact('count'));
    }

    public function renderSidebar()
    {
        // Retrieve the contact details from the database
        $contact = Contact::find($id); // Replace $contactId with the actual contact ID you want to display in the sidebar

        return view('includes.sidebar', compact('contact'));
    }
    ...
    public function UpdateContact(Request $request, Contact $contact)
    {
        ...
        $contact->country_id = $request->input('city');
