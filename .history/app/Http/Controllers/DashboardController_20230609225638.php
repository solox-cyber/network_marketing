...
class DashboardController extends Controller
{
    ...
    public function salessearch(Request $request)
    {
        ...
        // Perform the search query to retrieve the matching contacts
        $contacts = Contact::where('name', 'LIKE', '%' . $search . '%')->get();

        // Pass the contacts to the view and return the HTML representation of the search results
        return view('admin.salescontacts', compact('contacts'));
    }
