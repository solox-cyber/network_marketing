    ...
    public function index()
    {
        ...
        if (Auth::id()) {
            ...
            if ($usertype == 'user') {
                ...
                return view('dashboard', compact('course_name','commissionPercentage', 'lever', 'about_course', 'WalletAmountGross', 'contactCount','digit', 'course', 'userCount', 'totalCount', 'WalletAmount', 'commissionPercentage', 'level', 'service', 'serial_number'));
