        ...
        if (Auth::id()) {
            ...
            if ($usertype == 'user') {
                ...
                if ($course) {
                    ...
                    $courseDate = $course->title;
                    $courseDescription = $course->description;
                    // Retrieve other necessary course details

                    return view('course_details', compact('courseTitle', 'courseDescription'));
                } else {
                    // Handle the case when the user doesn't have a course assigned
                    return view('no_course_assigned');
                }
