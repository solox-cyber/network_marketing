...
class DashboardController extends Controller
{
    ...
    $sum = $user->contacts->sum('amount');
        return view('add-contact',compact('contacts'),compact('sum'));
    }
    ...
    public function EditContact()
    {
        ...
        $contacts = $user->contacts;
        $sum = $user->contacts->sum('amount');
        return view('edit-contact',compact('contacts'),compact('sum'));
    }
    ...
    public function contact()
    {
        ...
        $contacts = $user->contacts;
        $sum = $user->contacts->sum('amount');
        return view('contacts',compact('contacts'),compact('sum'));
    }
