...
class DashboardController extends Controller
{
    ...
    ->count();
                ...
                return view('dashboard', compact('course_name', 'about_course', 'N',  'contactCount', 'course', 'userCount', 'totalCount', 'totalCountusers', 'WalletAmount', 'commissionPercentage', 'level', 'service', 'serial_number'));
