    ...
    public function searchSales(Request $request)
{
    ...
    public function salesPayoutGate(Request $request){
        ...
        return redirect()->back('salespayment.payout')->with('success', 'Withdrawal recorded successfully.');
    }
    ...
    {
        if (auth()->user()->usertype === 'admin' || auth()->user()->usertype === 'subadmin' || auth()->user()->usertype === 'salesrep') {
                    $salesReps = User::where('usertype', 'salesrep')->paginate(10); // Change the page size (10) as per your requirement
