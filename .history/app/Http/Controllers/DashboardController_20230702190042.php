...
class DashboardController extends Controller
{
    ...
    public function index()
    {
        ...
        if (Auth::id()) {
            ...
            if ($usertype == 'user') {
                ...
                return view('pending', compact('courseDetails', 'contactCount', 'course', 'userCount', 'totalCount', 'WalletAmount', 'commissionPercentage', 'level', 'service', 'serial_number'));
    ...
    public function activated(Request $request, $token)
    {
        ...
        if ($user) {
            ...
            $user->activation_token = nupendll;
            $user->save();
        ...
        return View::make('activate-success');
        }
