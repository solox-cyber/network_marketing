        ...
        if (Auth::id()) {
            ...
            if ($usertype == 'user') {
                ...
                $course = $user->course;
                 ...
                 $courseStartDate = User::where('start_id', $course->id);
                ...
                return view('dashboard', compact('contactCount', 'courseDate', 'userCount', 'totalCount', 'WalletAmount', 'commissionPercentage', 'level', 'service', 'serial_number'));
