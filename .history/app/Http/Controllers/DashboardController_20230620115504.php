    ...
    public function index()
    {
        ...
        if (Auth::id()) {
            ...
            if ($usertype == 'user') {
                ...
                if ($totalCount >= ($N * 4 + 1) && $totalCount < ($N * 16 + 5)) {
                    $level = 1;
                ...
                return view('dashboard', compact('about_course', 'N',  'contactCount', 'course', 'userCount', 'totalCount', 'WalletAmount', 'commissionPercentage', 'level', 'service', 'serial_number'));
