    ...
    public function index()
    {
        ...
        if (Auth::id()) {
            ...
            if ($usertype == 'user') {
                ...
                $course = $user->service;
                $courseDetails = Course::where('start_id', $course)->get();

                foreach ($courseDetails as $course) {
                    $startDate = $course->course_logo;
                    $startDate = $course->course_name;
                    $startDate = $course->about_course;
                    $startDate = $course->course_syllabus;
                }
                ...
                return view('dashboard', compact('contactCount', 'course', 'userCount', 'totalCount', 'WalletAmount', 'commissionPercentage', 'level', 'service', 'serial_number'));
