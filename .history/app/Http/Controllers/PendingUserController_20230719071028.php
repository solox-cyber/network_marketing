...
class PendingUserController extends Controller
{
    ...
    public function saveUserData(Request $request)
    {
        try {
            ...
            $paymentUrl = 'https://your-payment-gateway.com/pay?user_id=' . $user->id . '&callback=' . route('payment.callback');

            // Send the registration email with the payment link
            Mail::to($user->email)->send(new UserRegistrationMail($user, $paymentUrl));
