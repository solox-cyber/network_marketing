...
class HomeController extends Controller
{
    ...
    if($countryCode === 'NG') {
        ...
        $pay = 100000 * $Rate;
                ...
                return view('dashboard', compact('courseDetails', 'contactCount', 'countryCode', 'course','userCount', 'totalCount', 'WalletAmount', 'commissionPercentage', 'level', 'service', 'serial_number'));
