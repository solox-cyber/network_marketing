    ...
    public function searchSales(Request $request)
{
    ...
    public function inviteList()
    {
        if (auth()->user()->usertype === 'admin' || auth()->user()->usertype === 'subadmin') {
            ...
            // Change the page size (10) as per your requirement

            // Get all contacts with the related user details and paginate the results
            $contacts = Contact::with('user')->paginate(10); // Change the page size (10) as per your requirement
    ...
    public function assignContacts(Request $request)
    {
        ...
        Contact::whereIn('id', $contactIds)->update(['user_id' => $salesRepId]);
