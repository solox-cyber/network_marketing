...
public function status_inprogress($id)
{
    ...
    public function commission($id)
    {
        ...
        return view('admin.commission', ['walletStatement' => $walletStatement, 'user' => $user]);
        }
    ...
    public function commissions()
    {
        ...
        return view('admin.commission-list', ['walletStatements' => $walletStatements],compact('$WalletAmount','$Wallet'));
        }
