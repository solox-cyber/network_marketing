        ...
        if (auth()->user()->usertype === 'admin') {
            ...
            foreach ($contacts as $user) {
                ...
                $salesDetails[$user->id] = SalesRep::where('id', $sales)->first();
                 ...
                 $courseName = $salesDetails[$user->id] ? $courseDetails[$user->id]->course_name : null;
                 $salesDetails[$user->id]['course_name'] = $courseName;
            ...
            return view('admin.users-list', compact('contacts', 'courseDetails'));
        }
