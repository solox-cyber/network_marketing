...
public function courseUpdate(Request $request, $id)
{
    ...
    // Log the SQL query instead of saving the changes to the database
    $query = DB::table('courses')->where('id', $id)->toSql();
    dd($query); // This will display the SQL query without saving it to the database
