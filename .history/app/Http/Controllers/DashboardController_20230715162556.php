    ...
    public function index()
    {
        ...
        if (Auth::id()) {
            ...
            if ($usertype == 'user') {
                ...
                $courseser = $user->service;
                $courseDetails = Course::where('id', Auth::id())->get();
                ...
                $N = intval(str_replace('SN-', '', $user->serial_number));
                // $level = 0;
                ...
                return view('dashboard', compact('courseDetails', 'N', 'contactCount', 'course', 'userCount', 'totalCount', 'WalletAmount', 'commissionPercentage', 'level', 'service', 'serial_number', 'enrollment_status'));
