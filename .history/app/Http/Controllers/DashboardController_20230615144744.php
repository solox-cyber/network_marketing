    ...
    public function Coursedetails($id)
{
    ...
    public function userlist()
    {
        ...
        if (auth()->user()->usertype === 'admin') {
            ...
            // Retrieve the course details of the user
            $course = auth()->user()->service;
            $courseDetails = Course::where('id', $course)->first(); // Use first() instead of get()

            // Check if course details exist
            $course_name = $courseDetails ? $courseDetails->course_name : null;

            return view('admin.users-list', compact('contacts', 'course_name'));
        }
