    ...
    public function index()
    {
        ...
        if (Auth::id()) {
            ...
            if ($usertype == 'user') {
                ...
                $courseDetails = Course::where('id', $courseser)->get();
                ...
                return view('dashboard', compact('courseDetails', 'contactCount', 'totalCount', 'id', 'course', 'userCount', 'totalCount', 'WalletAmount', 'commissionPercentage', 'level', 'service', 'serial_number', 'enrollment_status'));
