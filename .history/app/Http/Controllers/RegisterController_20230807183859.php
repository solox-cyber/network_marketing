...
class RegisterController extends Controller
{
    ...
    public function showRegistrationFormenroll(Request $request)
    {
        // Extract the course ID from the query parameter
        $selectedCourseId = $request->query('course_id');

        // Fetch the list of courses (you can adjust this based on your logic)
        $courses = Course::findorfail($selectedCourseId);

        // Pass the selected course ID and the list of courses to the view
        return view('auth.enroll', compact('courses'));
    }
