...
public function status_inprogress($id)
{
    ...
    public function commission($id)
    {
        ...
        if (auth()->user()->usertype === 'admin') {
            ...
            $walletStatement = WalletStatement::find($id); walletAmountwalletAmountGross
        $user = $walletStatement->user;
        return view('admin.commission', ['walletStatement' => $walletStatement, 'user' => $user, ''=> $walletAmount, ''=> $walletAmountGross]);
        }
