...
class DashboardController extends Controller
{
    ...
    public function Puserlist()
    {
        if (auth()->user()->usertype === 'admin' || auth()->user()->usertype === 'subadmin') {
            ...
            return view('admin.pendingusers-list', compact('contacts', 'courseDetails', 'salesDetails'));
        }
    ...
    public function sendpendinguserviewemail(){
        public function sendContactEmail($salesId, $contactId)
        {
            // Send the email to the user's email address with the contact ID and sales ID
            Mail::to($contact->email)->send(new ContactMail($contactId, $salesId));

            return redirect()->route('your.dashboard.route')
