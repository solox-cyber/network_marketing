    ...
    public function index()
    {
        ...
        if (Auth::id()) {
            ...
            if ($usertype == 'user') {
                ...
                $course = $user->service;
                $courseStartDate = Course::where('start_id', $course->id)->value('start_date');
                ...
                return view('dashboard', compact('contactCount', 'courseStartDate', 'userCount', 'totalCount', 'WalletAmount', 'commissionPercentage', 'level', 'service', 'serial_number'));
