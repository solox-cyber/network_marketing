    ...
    public function index()
    {
        ...
        if (Auth::id()) {
            ...
            if ($usertype == 'user') {
                ...
                }elseif ($digit > 0 && $totalCount >= ($digit * 256 + 85)) {
                    $level = 4;
                ...
                return view('dashboard', compact('course_name','cod', 'about_course', 'contactCount','digit', 'course', 'userCount', 'totalCount', 'WalletAmount', 'commissionPercentage', 'level', 'service', 'serial_number'));
