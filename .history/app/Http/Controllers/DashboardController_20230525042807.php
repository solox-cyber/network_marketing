...
class DashboardController extends Controller
{
    ...
    public function index()
    {
      ...
      $user = Auth::user();
      $count = $user->created_at;
    //   $contactCountDate = Contact::whereDate('created_at', '>', $user->created_at)->count();
    //   $userCountDate = User::whereDate('created_at', '>', $user->created_at)->count();
    //   $totalCount = $contactCountD + $userCount;

        return view('dashboard', compact('contactCount', 'userCount','contactCountDate','userCountDate'));
    }
