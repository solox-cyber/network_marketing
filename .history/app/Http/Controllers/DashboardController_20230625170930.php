    ...
    public function inviteList()
{
    if (auth()->user()->usertype === 'admin' || auth()->user()->usertype === 'subadmin') {
        ...
        // Get the user linked to a contact based on user's ID and contact's sales_rep_id
        $userLinkedContacts = Contact::with('user')
        ...
        return view('admin.invitations', compact('contacts', 'salesReps', 'userLinkedContacts'));
    }
}
