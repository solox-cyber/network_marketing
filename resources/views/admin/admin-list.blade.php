                    ...
                    <div class="card-header border-0 pt-6">
                        ...
                        <div class="card-title">
                            ...
                            <div class="d-flex align-items-center position-relative my-1">
                                ...
                                <form action="{{ route('searchUsers') }}" method="GET">
                                    <input type="text" name="search" class="form-control form-control-solid w-250px ps-13" placeholder="Search admin" />
                                </form>
                            </div>
                            <!--end::Search-->
                        </div>
                        ...
                        <div class="card-toolbar">
                            ...
                            <div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
                                ...
                                <a href="{{route('admin.create')}}" class="btn btn-primary me-4">
                                        ...
                                        <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4" data-kt-menu="true">
                                            ...
                                            <div class="menu-item px-3">
                                                <form action="{{ route('admin.destroy', ['id' => $contact->id]) }}" method="POST">
                                                    @csrf
                                                    @method('DELETE')
                                                    <button type="submit" class="menu-link px-3" onclick="return confirm('Are you sure you want to delete this admin user?')" style="background-color: transparent; border-color: transparent;">
                                                        Delete
                                                    </button>
                                                </form>
                                            </div>
